...
final class RumViewScope$updateActiveActionScope$1 extends Lambda implements Function1<RumContext, Boolean> {
    final /* synthetic */ RumViewScope this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    RumViewScope$updateActiveActionScope$1(RumViewScope rumViewScope) {
        super(1);
    ...
    public final Boolean invoke(RumContext rumContext) {
        ...
        if (Intrinsics.areEqual((Object) rumContext.getSessionId(), (Object) this.this$0.sessionId) && !Intrinsics.areEqual((Object) rumContext.getViewId(), (Object) this.this$0.getViewId$dd_sdk_android_release())) {
            LogUtilsKt.debugWithTelemetry$default(RuntimeUtilsKt.getSdkLogger(), RumViewScope.RUM_CONTEXT_UPDATE_IGNORED_AT_ACTION_UPDATE_MESSAGE, (Throwable) null, (Map) null, 6, (Object) null);
            z = false;
        }
