...
final class RumResourceInputStream$read$3 extends Lambda implements Function1<InputStream, Integer> {

    /* renamed from: $b */
    final /* synthetic */ byte[] f137$b;
    final /* synthetic */ int $len;
    final /* synthetic */ int $off;
    final /* synthetic */ RumResourceInputStream this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    RumResourceInputStream$read$3(byte[] bArr, int i, int i2, RumResourceInputStream rumResourceInputStream) {
        super(1);
        this.f137$b = bArr;
        this.$off = i;
        this.$len = i2;
    ...
    public final Integer invoke(InputStream inputStream) {
        ...
        Integer valueOf = Integer.valueOf(inputStream.read(this.f137$b, this.$off, this.$len));
