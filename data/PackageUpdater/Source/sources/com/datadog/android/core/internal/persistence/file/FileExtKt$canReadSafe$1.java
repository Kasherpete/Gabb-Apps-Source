...
final class FileExtKt$canReadSafe$1 extends Lambda implements Function1<File, Boolean> {
    public static final FileExtKt$canReadSafe$1 INSTANCE = new FileExtKt$canReadSafe$1();

    FileExtKt$canReadSafe$1() {
        super(1);
    }
