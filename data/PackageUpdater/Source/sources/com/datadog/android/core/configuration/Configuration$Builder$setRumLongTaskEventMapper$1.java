...
final class Configuration$Builder$setRumLongTaskEventMapper$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke() {
        ...
        builder.rumConfig = Configuration.Feature.RUM.copy$default(builder.rumConfig, (String) null, (List) null, 0.0f, 0.0f, (UserActionTrackingStrategy) null, (ViewTrackingStrategy) null, (TrackingStrategy) null, RumEventMapper.copy$default(this.this$0.getRumEventMapper(), (EventMapper) null, (EventMapper) null, (EventMapper) null, (EventMapper) null, this.$eventMapper, 15, (Object) null), false, 383, (Object) null);
    }
}
