...
final class FileExtKt$canWriteSafe$1 extends Lambda implements Function1<File, Boolean> {
    public static final FileExtKt$canWriteSafe$1 INSTANCE = new FileExtKt$canWriteSafe$1();

    FileExtKt$canWriteSafe$1() {
        super(1);
    }
