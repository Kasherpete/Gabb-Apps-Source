...
final class Configuration$Builder$useCustomLogsEndpoint$1 extends Lambda implements Function0<Unit> {
    ...
    Configuration$Builder$useCustomLogsEndpoint$1(Configuration.Builder builder, String str) {
        super(0);
        this.this$0 = builder;
        this.$endpoint = str;
    }
    ...
    public final void invoke() {
        ...
        builder.logsConfig = Configuration.Feature.Logs.copy$default(builder.logsConfig, this.$endpoint, (List) null, (EventMapper) null, 6, (Object) null);
