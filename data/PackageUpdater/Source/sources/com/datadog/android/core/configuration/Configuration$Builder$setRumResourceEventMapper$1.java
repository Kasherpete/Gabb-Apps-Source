...
final class Configuration$Builder$setRumResourceEventMapper$1 extends Lambda implements Function0<Unit> {
    ...
    Configuration$Builder$setRumResourceEventMapper$1(Configuration.Builder builder, EventMapper<ResourceEvent> eventMapper) {
        super(0);
        this.this$0 = builder;
    ...
    public final void invoke() {
        ...
        builder.rumConfig = Configuration.Feature.RUM.copy$default(builder.rumConfig, (String) null, (List) null, 0.0f, 0.0f, (UserActionTrackingStrategy) null, (ViewTrackingStrategy) null, (TrackingStrategy) null, RumEventMapper.copy$default(this.this$0.getRumEventMapper(), (EventMapper) null, (EventMapper) null, this.$eventMapper, (EventMapper) null, (EventMapper) null, 27, (Object) null), false, 383, (Object) null);
    }
}
