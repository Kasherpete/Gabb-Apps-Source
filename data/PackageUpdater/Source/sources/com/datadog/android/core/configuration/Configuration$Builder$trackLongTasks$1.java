...
final class Configuration$Builder$trackLongTasks$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke() {
        ...
        builder.rumConfig = Configuration.Feature.RUM.copy$default(builder.rumConfig, (String) null, (List) null, 0.0f, 0.0f, (UserActionTrackingStrategy) null, (ViewTrackingStrategy) null, new MainLooperLongTaskStrategy(this.$longTaskThresholdMs), (EventMapper) null, false, 447, (Object) null);
    }
}
