...
public class MaterialColors {
    ...
    public static int harmonizeWithPrimary(Context context, int i) {
        return harmonize(i, getColor(context, C0915R.attr.colorPrimary, MaterialColors.class.getCanonicalName()));
    }
    ...
    public static ColorRoles getColorRoles(Context context, int i) {
        return getColorRoles(i, MaterialAttributes.resolveBoolean(context, C0915R.attr.isLightTheme, true));
    }
