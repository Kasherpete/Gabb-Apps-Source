...
class FloatingActionButtonImpl {
    ...
    private AnimatorSet createDefaultAnimator(float f, float f2, float f3) {
        ...
        arrayList.add(ofFloat);
        AnimatorSetCompat.playTogether(animatorSet, arrayList);
        animatorSet.setDuration((long) MotionUtils.resolveThemeDuration(this.view.getContext(), C0915R.attr.motionDurationLong1, this.view.getContext().getResources().getInteger(C0915R.integer.material_motion_duration_long_1)));
        animatorSet.setInterpolator(MotionUtils.resolveThemeInterpolator(this.view.getContext(), C0915R.attr.motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        return animatorSet;
    }
