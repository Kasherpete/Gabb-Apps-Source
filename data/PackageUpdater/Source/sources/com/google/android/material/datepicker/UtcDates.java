...
class UtcDates {
    ...
    static String getTextInputHint(Resources resources, SimpleDateFormat simpleDateFormat) {
        ...
        String string = resources.getString(C0915R.string.mtrl_picker_text_input_year_abbr);
        String string2 = resources.getString(C0915R.string.mtrl_picker_text_input_month_abbr);
        String string3 = resources.getString(C0915R.string.mtrl_picker_text_input_day_abbr);
