...
public final class MaterialContainerTransform extends Transition {
    ...
    private static void captureValues(TransitionValues transitionValues, View view, int i, ShapeAppearanceModel shapeAppearanceModel) {
        ...
        } else if (transitionValues.view.getTag(C0915R.C0918id.mtrl_motion_snapshot_view) instanceof View) {
            transitionValues.view.setTag(C0915R.C0918id.mtrl_motion_snapshot_view, (Object) null);
            transitionValues.view = (View) transitionValues.view.getTag(C0915R.C0918id.mtrl_motion_snapshot_view);
        }
    ...
    private static ShapeAppearanceModel getShapeAppearance(View view, ShapeAppearanceModel shapeAppearanceModel) {
        ...
        if (view.getTag(C0915R.C0918id.mtrl_motion_snapshot_view) instanceof ShapeAppearanceModel) {
            return (ShapeAppearanceModel) view.getTag(C0915R.C0918id.mtrl_motion_snapshot_view);
        }
    ...
    private static int getTransitionShapeAppearanceResId(Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(new int[]{C0915R.attr.transitionShapeAppearance});
    ...
    private void maybeApplyThemeValues(Context context, boolean z) {
        TransitionUtils.maybeApplyThemeInterpolator(this, context, C0915R.attr.motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        TransitionUtils.maybeApplyThemeDuration(this, context, z ? C0915R.attr.motionDurationLong1 : C0915R.attr.motionDurationMedium2);
        if (!this.pathMotionCustom) {
            TransitionUtils.maybeApplyThemePath(this, context, C0915R.attr.motionPath);
        }
    }
