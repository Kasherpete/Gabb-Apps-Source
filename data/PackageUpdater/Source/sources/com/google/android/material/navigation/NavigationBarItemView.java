...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public NavigationBarItemView(Context context) {
        ...
        this.iconContainer = (FrameLayout) findViewById(C0915R.C0918id.navigation_bar_item_icon_container);
        this.activeIndicatorView = findViewById(C0915R.C0918id.navigation_bar_item_active_indicator_view);
        ImageView imageView = (ImageView) findViewById(C0915R.C0918id.navigation_bar_item_icon_view);
        this.icon = imageView;
        ViewGroup viewGroup = (ViewGroup) findViewById(C0915R.C0918id.navigation_bar_item_labels_group);
        this.labelGroup = viewGroup;
        TextView textView = (TextView) findViewById(C0915R.C0918id.navigation_bar_item_small_label_view);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(C0915R.C0918id.navigation_bar_item_large_label_view);
    ...
    private void maybeAnimateActiveIndicatorToProgress(final float f) {
        ...
        this.activeIndicatorAnimator.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C0915R.attr.motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        this.activeIndicatorAnimator.setDuration((long) MotionUtils.resolveThemeDuration(getContext(), C0915R.attr.motionDurationLong1, getResources().getInteger(C0915R.integer.material_motion_duration_long_1)));
    ...
    public int getItemBackgroundResId() {
        return C0915R.C0917drawable.mtrl_navigation_bar_item_background;
    }

    /* access modifiers changed from: protected */
    public int getItemDefaultMarginResId() {
        return C0915R.dimen.mtrl_navigation_bar_item_default_margin;
    }
