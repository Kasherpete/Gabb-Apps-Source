...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private static final int DEFAULT_STYLE = C0915R.style.Widget_MaterialComponents_Badge;
    private static final int DEFAULT_THEME_ATTR = C0915R.attr.badgeStyle;
    ...
    public static final class SavedState implements Parcelable {
        ...
        public SavedState(Context context) {
            this.badgeTextColor = new TextAppearance(context, C0915R.style.TextAppearance_MaterialComponents_Badge).getTextColor().getDefaultColor();
            this.contentDescriptionNumberless = context.getString(C0915R.string.mtrl_badge_numberless_content_description);
            this.contentDescriptionQuantityStrings = C0915R.plurals.mtrl_badge_content_description;
            this.contentDescriptionExceedsMaxBadgeNumberRes = C0915R.string.mtrl_exceed_max_badge_number_content_description;
            this.isVisible = true;
        }
    ...
    private void loadDefaultStateFromAttributes(Context context, AttributeSet attributeSet, int i, int i2) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C0915R.styleable.Badge, i, i2, new int[0]);
        setMaxCharacterCount(obtainStyledAttributes.getInt(C0915R.styleable.Badge_maxCharacterCount, 4));
        if (obtainStyledAttributes.hasValue(C0915R.styleable.Badge_number)) {
            setNumber(obtainStyledAttributes.getInt(C0915R.styleable.Badge_number, 0));
        }
        setBackgroundColor(readColorFromAttributes(context, obtainStyledAttributes, C0915R.styleable.Badge_backgroundColor));
        if (obtainStyledAttributes.hasValue(C0915R.styleable.Badge_badgeTextColor)) {
            setBadgeTextColor(readColorFromAttributes(context, obtainStyledAttributes, C0915R.styleable.Badge_badgeTextColor));
        }
        setBadgeGravity(obtainStyledAttributes.getInt(C0915R.styleable.Badge_badgeGravity, TOP_END));
        setHorizontalOffsetWithoutText(obtainStyledAttributes.getDimensionPixelOffset(C0915R.styleable.Badge_horizontalOffset, 0));
        setVerticalOffsetWithoutText(obtainStyledAttributes.getDimensionPixelOffset(C0915R.styleable.Badge_verticalOffset, 0));
        setHorizontalOffsetWithText(obtainStyledAttributes.getDimensionPixelOffset(C0915R.styleable.Badge_horizontalOffsetWithText, getHorizontalOffsetWithoutText()));
        setVerticalOffsetWithText(obtainStyledAttributes.getDimensionPixelOffset(C0915R.styleable.Badge_verticalOffsetWithText, getVerticalOffsetWithoutText()));
        if (obtainStyledAttributes.hasValue(C0915R.styleable.Badge_badgeRadius)) {
            this.badgeRadius = (float) obtainStyledAttributes.getDimensionPixelSize(C0915R.styleable.Badge_badgeRadius, (int) this.badgeRadius);
        }
        if (obtainStyledAttributes.hasValue(C0915R.styleable.Badge_badgeWidePadding)) {
            this.badgeWidePadding = (float) obtainStyledAttributes.getDimensionPixelSize(C0915R.styleable.Badge_badgeWidePadding, (int) this.badgeWidePadding);
        }
        if (obtainStyledAttributes.hasValue(C0915R.styleable.Badge_badgeWithTextRadius)) {
            this.badgeWithTextRadius = (float) obtainStyledAttributes.getDimensionPixelSize(C0915R.styleable.Badge_badgeWithTextRadius, (int) this.badgeWithTextRadius);
        }
    ...
    private BadgeDrawable(Context context) {
        ...
        this.badgeRadius = (float) resources.getDimensionPixelSize(C0915R.dimen.mtrl_badge_radius);
        this.badgeWidePadding = (float) resources.getDimensionPixelSize(C0915R.dimen.mtrl_badge_long_text_horizontal_padding);
        this.badgeWithTextRadius = (float) resources.getDimensionPixelSize(C0915R.dimen.mtrl_badge_with_text_radius);
        TextDrawableHelper textDrawableHelper2 = new TextDrawableHelper(this);
        this.textDrawableHelper = textDrawableHelper2;
        textDrawableHelper2.getTextPaint().setTextAlign(Paint.Align.CENTER);
        this.savedState = new SavedState(context);
        setTextAppearanceResource(C0915R.style.TextAppearance_MaterialComponents_Badge);
    }
    ...
    private void tryWrapAnchorInCompatParent(final View view) {
        ...
        if (viewGroup == null || viewGroup.getId() != C0915R.C0918id.mtrl_anchor_parent) {
            WeakReference<FrameLayout> weakReference = this.customBadgeParentRef;
            if (weakReference == null || weakReference.get() != viewGroup) {
                updateAnchorParentToNotClip(view);
                final FrameLayout frameLayout = new FrameLayout(view.getContext());
                frameLayout.setId(C0915R.C0918id.mtrl_anchor_parent);
    ...
    private void calculateCenterAndBounds(Context context, Rect rect, View view) {
        ...
        int dimensionPixelSize = context.getResources().getDimensionPixelSize(hasNumber() ? C0915R.dimen.mtrl_badge_text_horizontal_edge_offset : C0915R.dimen.mtrl_badge_horizontal_edge_offset);
    ...
    private String getBadgeText() {
        ...
        return context.getString(C0915R.string.mtrl_exceed_max_badge_number_suffix, new Object[]{Integer.valueOf(this.maxBadgeNumber), DEFAULT_EXCEED_MAX_BADGE_NUMBER_SUFFIX});
    }
