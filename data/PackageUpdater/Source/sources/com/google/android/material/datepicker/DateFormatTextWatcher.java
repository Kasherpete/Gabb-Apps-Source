...
abstract class DateFormatTextWatcher extends TextWatcherAdapter {
    ...
    DateFormatTextWatcher(final String str, DateFormat dateFormat2, TextInputLayout textInputLayout2, CalendarConstraints calendarConstraints) {
        ...
        this.outOfRange = textInputLayout2.getContext().getString(C0915R.string.mtrl_picker_out_of_range);
        this.setErrorCallback = new Runnable() {
            public void run() {
                ...
                String string = context.getString(C0915R.string.mtrl_picker_invalid_format);
                String format = String.format(context.getString(C0915R.string.mtrl_picker_invalid_format_use), new Object[]{str});
                access$000.setError(string + "\n" + format + "\n" + String.format(context.getString(C0915R.string.mtrl_picker_invalid_format_example), new Object[]{access$100.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis()))}));
