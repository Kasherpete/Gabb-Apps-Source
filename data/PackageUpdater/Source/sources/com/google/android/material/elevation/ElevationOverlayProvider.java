...
public class ElevationOverlayProvider {
    ...
    public ElevationOverlayProvider(Context context) {
        this(MaterialAttributes.resolveBoolean(context, C0915R.attr.elevationOverlayEnabled, false), MaterialColors.getColor(context, C0915R.attr.elevationOverlayColor, 0), MaterialColors.getColor(context, C0915R.attr.elevationOverlayAccentColor, 0), MaterialColors.getColor(context, C0915R.attr.colorSurface, 0), context.getResources().getDisplayMetrics().density);
    }
