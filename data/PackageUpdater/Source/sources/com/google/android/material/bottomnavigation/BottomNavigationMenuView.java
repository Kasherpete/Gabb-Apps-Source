...
public class BottomNavigationMenuView extends NavigationBarMenuView {
    ...
    public BottomNavigationMenuView(Context context) {
        ...
        this.inactiveItemMaxWidth = resources.getDimensionPixelSize(C0915R.dimen.design_bottom_navigation_item_max_width);
        this.inactiveItemMinWidth = resources.getDimensionPixelSize(C0915R.dimen.design_bottom_navigation_item_min_width);
        this.activeItemMaxWidth = resources.getDimensionPixelSize(C0915R.dimen.design_bottom_navigation_active_item_max_width);
        this.activeItemMinWidth = resources.getDimensionPixelSize(C0915R.dimen.design_bottom_navigation_active_item_min_width);
    }
