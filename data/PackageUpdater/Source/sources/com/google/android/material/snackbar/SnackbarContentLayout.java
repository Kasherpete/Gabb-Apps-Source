...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public void onFinishInflate() {
        ...
        this.messageView = (TextView) findViewById(C0915R.C0918id.snackbar_text);
        this.actionView = (Button) findViewById(C0915R.C0918id.snackbar_action);
    }
    ...
    public void updateActionTextColorAlphaIfNeeded(float f) {
        if (f != 1.0f) {
            this.actionView.setTextColor(MaterialColors.layer(MaterialColors.getColor(this, C0915R.attr.colorSurface), this.actionView.getCurrentTextColor(), f));
        }
    }
    ...
    public void onMeasure(int r8, int r9) {
        /*
            ...
            int r1 = com.google.android.material.C0915R.dimen.design_snackbar_padding_vertical_2lines
            int r0 = r0.getDimensionPixelSize(r1)
            android.content.res.Resources r1 = r7.getResources()
            int r2 = com.google.android.material.C0915R.dimen.design_snackbar_padding_vertical
