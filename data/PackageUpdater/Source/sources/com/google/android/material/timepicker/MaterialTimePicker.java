...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(context, C0915R.attr.colorSurface, MaterialTimePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, (AttributeSet) null, C0915R.attr.materialTimePickerStyle, C0915R.style.Widget_MaterialComponents_TimePicker);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes((AttributeSet) null, C0915R.styleable.MaterialTimePicker, C0915R.attr.materialTimePickerStyle, C0915R.style.Widget_MaterialComponents_TimePicker);
        this.clockIcon = obtainStyledAttributes.getResourceId(C0915R.styleable.MaterialTimePicker_clockIcon, 0);
        this.keyboardIcon = obtainStyledAttributes.getResourceId(C0915R.styleable.MaterialTimePicker_keyboardIcon, 0);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ViewGroup viewGroup2 = (ViewGroup) layoutInflater.inflate(C0915R.C0920layout.material_timepicker_dialog, viewGroup);
        TimePickerView timePickerView2 = (TimePickerView) viewGroup2.findViewById(C0915R.C0918id.material_timepicker_view);
        this.timePickerView = timePickerView2;
        timePickerView2.setOnDoubleTapListener(this);
        this.textInputStub = (ViewStub) viewGroup2.findViewById(C0915R.C0918id.material_textinput_timepicker);
        this.modeButton = (MaterialButton) viewGroup2.findViewById(C0915R.C0918id.material_timepicker_mode_button);
        TextView textView = (TextView) viewGroup2.findViewById(C0915R.C0918id.header_title);
        ...
        Button button = (Button) viewGroup2.findViewById(C0915R.C0918id.material_timepicker_ok_button);
        ...
        Button button2 = (Button) viewGroup2.findViewById(C0915R.C0918id.material_timepicker_cancel_button);
    ...
    private Pair<Integer, Integer> dataForMode(int i) {
        if (i == 0) {
            return new Pair<>(Integer.valueOf(this.keyboardIcon), Integer.valueOf(C0915R.string.material_timepicker_text_input_mode_description));
        }
        if (i == 1) {
            return new Pair<>(Integer.valueOf(this.clockIcon), Integer.valueOf(C0915R.string.material_timepicker_clock_mode_description));
        }
    ...
    private int getThemeResId() {
        ...
        TypedValue resolve = MaterialAttributes.resolve(requireContext(), C0915R.attr.materialTimePickerTheme);
        if (resolve == null) {
            return 0;
        }
        return resolve.data;
