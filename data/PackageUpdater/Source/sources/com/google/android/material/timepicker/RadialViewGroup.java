...
class RadialViewGroup extends ConstraintLayout {
    ...
    public RadialViewGroup(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C0915R.C0920layout.material_radial_view_group, this);
        ViewCompat.setBackground(this, createBackground());
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0915R.styleable.RadialViewGroup, i, 0);
        this.radius = obtainStyledAttributes.getDimensionPixelSize(C0915R.styleable.RadialViewGroup_materialCircleRadius, 0);
    ...
    public void updateLayoutParams() {
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            if (childAt.getId() != C0915R.C0918id.circle_center && !shouldSkipView(childAt)) {
                constraintSet.constrainCircle(childAt.getId(), C0915R.C0918id.circle_center, this.radius, f);
