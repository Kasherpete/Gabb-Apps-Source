...
public class DynamicColors {
    ...
    private static final int[] DYNAMIC_COLOR_THEME_OVERLAY_ATTRIBUTE = {C0915R.attr.dynamicColorThemeOverlay};
    ...
    static {
        C09691 r0 = new DeviceSupportCondition() {
            public boolean isSupported() {
                return true;
            }
        };
        DEFAULT_DEVICE_SUPPORT_CONDITION = r0;
        C09702 r1 = new DeviceSupportCondition() {
