...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(context, C0915R.attr.colorSurface, MaterialDatePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, (AttributeSet) null, C0915R.attr.materialCalendarStyle, C0915R.style.Widget_MaterialComponents_MaterialCalendar);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(this.fullscreen ? C0915R.C0920layout.mtrl_picker_fullscreen : C0915R.C0920layout.mtrl_picker_dialog, viewGroup);
        Context context = inflate.getContext();
        if (this.fullscreen) {
            inflate.findViewById(C0915R.C0918id.mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            inflate.findViewById(C0915R.C0918id.mtrl_calendar_main_pane).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -1));
        }
        TextView textView = (TextView) inflate.findViewById(C0915R.C0918id.mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        ViewCompat.setAccessibilityLiveRegion(textView, 1);
        this.headerToggleButton = (CheckableImageButton) inflate.findViewById(C0915R.C0918id.mtrl_picker_header_toggle);
        TextView textView2 = (TextView) inflate.findViewById(C0915R.C0918id.mtrl_picker_title_text);
        ...
        this.confirmButton = (Button) inflate.findViewById(C0915R.C0918id.confirm_button);
        ...
        Button button = (Button) inflate.findViewById(C0915R.C0918id.cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int dimensionPixelOffset = getResources().getDimensionPixelOffset(C0915R.dimen.mtrl_calendar_dialog_background_inset);
    ...
    public void updateHeader() {
        ...
        this.headerSelectionText.setContentDescription(String.format(getString(C0915R.string.mtrl_picker_announce_current_selection), new Object[]{headerText}));
    ...
    public void startPickerFragment() {
        ...
        beginTransaction.replace(C0915R.C0918id.mtrl_calendar_frame, this.pickerFragment);
    ...
    public void updateToggleContentDescription(CheckableImageButton checkableImageButton) {
        ...
        if (this.headerToggleButton.isChecked()) {
            str = checkableImageButton.getContext().getString(C0915R.string.mtrl_picker_toggle_to_calendar_input_mode);
        } else {
            str = checkableImageButton.getContext().getString(C0915R.string.mtrl_picker_toggle_to_text_input_mode);
        }
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{16842912}, AppCompatResources.getDrawable(context, C0915R.C0917drawable.material_ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], AppCompatResources.getDrawable(context, C0915R.C0917drawable.material_ic_edit_black_24dp));
    ...
    static boolean isNestedScrollable(Context context) {
        return readMaterialCalendarStyleBoolean(context, C0915R.attr.nestedScrollable);
    }

    static boolean readMaterialCalendarStyleBoolean(Context context, int i) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C0915R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{i});
    ...
    private static int getPaddedPickerWidth(Context context) {
        ...
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C0915R.dimen.mtrl_calendar_content_padding);
        int i = Month.current().daysInWeek;
        return (dimensionPixelOffset * 2) + (resources.getDimensionPixelSize(C0915R.dimen.mtrl_calendar_day_width) * i) + ((i - 1) * resources.getDimensionPixelOffset(C0915R.dimen.mtrl_calendar_month_horizontal_padding));
    }
