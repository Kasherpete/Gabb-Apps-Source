...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    private static final int DEF_STYLE_ATTR = C0915R.attr.alertDialogStyle;
    private static final int DEF_STYLE_RES = C0915R.style.MaterialAlertDialog_MaterialComponents;
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C0915R.attr.materialAlertDialogTheme;
    ...
    public MaterialAlertDialogBuilder(Context context, int i) {
        ...
        int color = MaterialColors.getColor(context2, C0915R.attr.colorSurface, getClass().getCanonicalName());
