...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
        ...
        this.selectionListener = new View.OnClickListener() {
            public void onClick(View view) {
                if (TimePickerView.this.onSelectionChangeListener != null) {
                    TimePickerView.this.onSelectionChangeListener.onSelectionChanged(((Integer) view.getTag(C0915R.C0918id.selection_type)).intValue());
                }
            }
        };
        LayoutInflater.from(context).inflate(C0915R.C0920layout.material_timepicker, this);
        this.clockFace = (ClockFaceView) findViewById(C0915R.C0918id.material_clock_face);
        MaterialButtonToggleGroup materialButtonToggleGroup = (MaterialButtonToggleGroup) findViewById(C0915R.C0918id.material_clock_period_toggle);
        this.toggle = materialButtonToggleGroup;
        materialButtonToggleGroup.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() {
            public void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup, int i, boolean z) {
                int i2 = i == C0915R.C0918id.material_clock_period_pm_button ? 1 : 0;
                if (TimePickerView.this.onPeriodChangeListener != null && z) {
                    TimePickerView.this.onPeriodChangeListener.onPeriodChange(i2);
                }
            }
        });
        Chip chip = (Chip) findViewById(C0915R.C0918id.material_minute_tv);
        this.minuteView = chip;
        Chip chip2 = (Chip) findViewById(C0915R.C0918id.material_hour_tv);
        this.hourView = chip2;
        this.clockHandView = (ClockHandView) findViewById(C0915R.C0918id.material_clock_hand);
    ...
    private void setupDoubleTap() {
        ...
        C11574 r1 = new View.OnTouchListener() {
    ...
    private void setUpDisplay() {
        this.minuteView.setTag(C0915R.C0918id.selection_type, 12);
        this.hourView.setTag(C0915R.C0918id.selection_type, 10);
    ...
    public void updateTime(int i, int i2, int i3) {
        this.toggle.check(i == 1 ? C0915R.C0918id.material_clock_period_pm_button : C0915R.C0918id.material_clock_period_am_button);
    ...
    private void updateToggleConstraints() {
        if (this.toggle.getVisibility() == 0) {
            ...
            constraintSet.clear(C0915R.C0918id.material_clock_display, i);
