...
final class RunSuspend implements Continuation<Unit> {
    ...
    public void resumeWith(Object obj) {
        synchronized (this) {
            this.result = Result.m175boximpl(obj);
            notifyAll();
    ...
    public final void await() {
        synchronized (this) {
            while (true) {
                Result<Unit> r0 = m1363getResultxLWZpok();
                if (r0 == null) {
                    wait();
                } else {
                    ResultKt.throwOnFailure(r0.m185unboximpl());
                }
            }
        }
    }
