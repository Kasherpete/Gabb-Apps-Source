...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    /* renamed from: ln */
    private static final double m90ln(double d) {
        return Math.log(d);
    }
    ...
    /* renamed from: ln */
    private static final float m91ln(float f) {
