...
@Metadata(mo20733bv = {1, 0, 3}, mo20734d1 = {"\u0000%\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\b\u0010\u0004\u001a\u00020\u0005H\u0016J\b\u0010\u0006\u001a\u00020\u0005H\u0016J\b\u0010\u0002\u001a\u00020\u0003H\u0016J\u0018\u0010\u0007\u001a\u00020\u00052\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000bH\u0016R\u000e\u0010\u0002\u001a\u00020\u0003X\u0004¢\u0006\u0002\n\u0000¨\u0006\f"}, mo20735d2 = {"okio/Pipe$sink$1", "Lokio/Sink;", "timeout", "Lokio/Timeout;", "close", "", "flush", "write", "source", "Lokio/Buffer;", "byteCount", "", "okio"}, mo20736k = 1, mo20737mv = {1, 4, 0})
...
public final class Pipe$sink$1 implements Sink {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x0059, code lost:
        r10 = r10.this$0;
        r1 = r0.timeout();
        r10 = r10.sink().timeout();
        r2 = r1.timeoutNanos();
        r1.timeout(okio.Timeout.Companion.minTimeout(r10.timeoutNanos(), r1.timeoutNanos()), java.util.concurrent.TimeUnit.NANOSECONDS);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x0082, code lost:
        if (r1.hasDeadline() == false) goto L_0x00bf;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0084, code lost:
        r4 = r1.deadlineNanoTime();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:27:0x008c, code lost:
        if (r10.hasDeadline() == false) goto L_0x009d;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x008e, code lost:
        r1.deadlineNanoTime(java.lang.Math.min(r1.deadlineNanoTime(), r10.deadlineNanoTime()));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:40:0x00c3, code lost:
        if (r10.hasDeadline() == false) goto L_0x00cc;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:41:0x00c5, code lost:
        r1.deadlineNanoTime(r10.deadlineNanoTime());
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:49:0x00e8, code lost:
        if (r10.hasDeadline() != false) goto L_0x00ea;
     */
    ...
    public void close() {
        /*
            ...
            okio.Pipe r1 = r10.this$0
            okio.Buffer r1 = r1.getBuffer$okio()
            monitor-enter(r1)
            okio.Pipe r2 = r10.this$0     // Catch:{ all -> 0x00f7 }
        ...
        L_0x001e:
            ...
            goto L_0x0041
        L_0x0037:
            java.io.IOException r10 = new java.io.IOException     // Catch:{ all -> 0x00f7 }
            java.lang.String r0 = "source is closed"
            r10.<init>(r0)     // Catch:{ all -> 0x00f7 }
            java.lang.Throwable r10 = (java.lang.Throwable) r10     // Catch:{ all -> 0x00f7 }
        ...
        L_0x0054:
            ...
            okio.Pipe r10 = r10.this$0
            okio.Timeout r1 = r0.timeout()
            okio.Sink r10 = r10.sink()
            okio.Timeout r10 = r10.timeout()
            long r2 = r1.timeoutNanos()
            okio.Timeout$Companion r4 = okio.Timeout.Companion
            long r5 = r10.timeoutNanos()
            long r7 = r1.timeoutNanos()
            ...
            boolean r6 = r10.hasDeadline()
            if (r6 == 0) goto L_0x009d
            long r6 = r1.deadlineNanoTime()
            long r8 = r10.deadlineNanoTime()
            long r6 = java.lang.Math.min(r6, r8)
            r1.deadlineNanoTime(r6)
        L_0x009d:
        ...
        L_0x00ee:
            return
        L_0x00ef:
            java.lang.NullPointerException r10 = new java.lang.NullPointerException     // Catch:{ all -> 0x00f7 }
