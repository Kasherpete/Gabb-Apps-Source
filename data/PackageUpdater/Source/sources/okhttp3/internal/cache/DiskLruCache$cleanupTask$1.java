...
@Metadata(mo20733bv = {1, 0, 3}, mo20734d1 = {"\u0000\u0011\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H\u0016¨\u0006\u0004"}, mo20735d2 = {"okhttp3/internal/cache/DiskLruCache$cleanupTask$1", "Lokhttp3/internal/concurrent/Task;", "runOnce", "", "okhttp"}, mo20736k = 1, mo20737mv = {1, 4, 0})
...
public final class DiskLruCache$cleanupTask$1 extends Task {
    ...
    public long runOnce() {
        ...
        L_0x0036:
            ...
            okhttp3.internal.cache.DiskLruCache r6 = r6.this$0     // Catch:{ all -> 0x004c }
            okio.Sink r1 = okio.Okio.blackhole()     // Catch:{ all -> 0x004c }
            okio.BufferedSink r1 = okio.Okio.buffer((okio.Sink) r1)     // Catch:{ all -> 0x004c }
            r6.journalWriter = r1     // Catch:{ all -> 0x004c }
        L_0x0048:
            monitor-exit(r0)
            return r2
        L_0x004a:
