...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:21:0x00b0 A[Catch:{ IOException -> 0x010f }] */
    ...
    public final void connect(int r17, int r18, int r19, int r20, boolean r21, okhttp3.Call r22, okhttp3.EventListener r23) {
        ...
        L_0x00a7:
            r13 = r0
        L_0x00a8:
            okhttp3.Route r0 = r7.route     // Catch:{ IOException -> 0x010f }
            boolean r0 = r0.requiresTunnel()     // Catch:{ IOException -> 0x010f }
            ...
            r5 = r22
            r6 = r23
            r1.connectTunnel(r2, r3, r4, r5, r6)     // Catch:{ IOException -> 0x010f }
            java.net.Socket r0 = r7.rawSocket     // Catch:{ IOException -> 0x010f }
        ...
        L_0x00c9:
            r14 = r17
            r15 = r18
            r7.connectSocket(r14, r15, r8, r9)     // Catch:{ IOException -> 0x010d }
        L_0x00d0:
            r6 = r20
            r7.establishProtocol(r12, r6, r8, r9)     // Catch:{ IOException -> 0x010b }
            okhttp3.Route r0 = r7.route     // Catch:{ IOException -> 0x010b }
            java.net.InetSocketAddress r0 = r0.socketAddress()     // Catch:{ IOException -> 0x010b }
            okhttp3.Route r1 = r7.route     // Catch:{ IOException -> 0x010b }
            java.net.Proxy r1 = r1.proxy()     // Catch:{ IOException -> 0x010b }
            okhttp3.Protocol r2 = r7.protocol     // Catch:{ IOException -> 0x010b }
            r9.connectEnd(r8, r0, r1, r2)     // Catch:{ IOException -> 0x010b }
        L_0x00e6:
    ...
    private final void connectTls(okhttp3.internal.connection.ConnectionSpecSelector r11) throws java.io.IOException {
        /*
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNull(r1)     // Catch:{ all -> 0x01a7 }
            java.net.Socket r4 = r10.rawSocket     // Catch:{ all -> 0x01a7 }
            okhttp3.HttpUrl r5 = r0.url()     // Catch:{ all -> 0x01a7 }
            java.lang.String r5 = r5.host()     // Catch:{ all -> 0x01a7 }
            okhttp3.HttpUrl r6 = r0.url()     // Catch:{ all -> 0x01a7 }
            int r6 = r6.port()     // Catch:{ all -> 0x01a7 }
            r7 = 1
            java.net.Socket r1 = r1.createSocket(r4, r5, r6, r7)     // Catch:{ all -> 0x01a7 }
            if (r1 == 0) goto L_0x019f
            javax.net.ssl.SSLSocket r1 = (javax.net.ssl.SSLSocket) r1     // Catch:{ all -> 0x01a7 }
            okhttp3.ConnectionSpec r11 = r11.configureSecureSocket(r1)     // Catch:{ all -> 0x019c }
            boolean r3 = r11.supportsTlsExtensions()     // Catch:{ all -> 0x019c }
            if (r3 == 0) goto L_0x004b
            okhttp3.internal.platform.Platform$Companion r3 = okhttp3.internal.platform.Platform.Companion     // Catch:{ all -> 0x019c }
            okhttp3.internal.platform.Platform r3 = r3.get()     // Catch:{ all -> 0x019c }
            okhttp3.HttpUrl r4 = r0.url()     // Catch:{ all -> 0x019c }
            java.lang.String r4 = r4.host()     // Catch:{ all -> 0x019c }
            java.util.List r5 = r0.protocols()     // Catch:{ all -> 0x019c }
            r3.configureTlsExtensions(r1, r4, r5)     // Catch:{ all -> 0x019c }
        L_0x004b:
            r1.startHandshake()     // Catch:{ all -> 0x019c }
            javax.net.ssl.SSLSession r3 = r1.getSession()     // Catch:{ all -> 0x019c }
            okhttp3.Handshake$Companion r4 = okhttp3.Handshake.Companion     // Catch:{ all -> 0x019c }
            java.lang.String r5 = "sslSocketSession"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r3, r5)     // Catch:{ all -> 0x019c }
            okhttp3.Handshake r4 = r4.get(r3)     // Catch:{ all -> 0x019c }
            javax.net.ssl.HostnameVerifier r5 = r0.hostnameVerifier()     // Catch:{ all -> 0x019c }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r5)     // Catch:{ all -> 0x019c }
            okhttp3.HttpUrl r6 = r0.url()     // Catch:{ all -> 0x019c }
            java.lang.String r6 = r6.host()     // Catch:{ all -> 0x019c }
            boolean r3 = r5.verify(r6, r3)     // Catch:{ all -> 0x019c }
            if (r3 != 0) goto L_0x0121
            java.util.List r10 = r4.peerCertificates()     // Catch:{ all -> 0x019c }
            r11 = r10
            java.util.Collection r11 = (java.util.Collection) r11     // Catch:{ all -> 0x019c }
            boolean r11 = r11.isEmpty()     // Catch:{ all -> 0x019c }
            r11 = r11 ^ r7
            if (r11 == 0) goto L_0x00f8
            r11 = 0
            java.lang.Object r10 = r10.get(r11)     // Catch:{ all -> 0x019c }
            if (r10 != 0) goto L_0x008f
            java.lang.NullPointerException r10 = new java.lang.NullPointerException     // Catch:{ all -> 0x019c }
            java.lang.String r11 = "null cannot be cast to non-null type java.security.cert.X509Certificate"
            r10.<init>(r11)     // Catch:{ all -> 0x019c }
            throw r10     // Catch:{ all -> 0x019c }
        L_0x008f:
            java.security.cert.X509Certificate r10 = (java.security.cert.X509Certificate) r10     // Catch:{ all -> 0x019c }
            javax.net.ssl.SSLPeerUnverifiedException r11 = new javax.net.ssl.SSLPeerUnverifiedException     // Catch:{ all -> 0x019c }
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ all -> 0x019c }
            r3.<init>()     // Catch:{ all -> 0x019c }
            java.lang.String r4 = "\n              |Hostname "
            java.lang.StringBuilder r3 = r3.append(r4)     // Catch:{ all -> 0x019c }
            okhttp3.HttpUrl r0 = r0.url()     // Catch:{ all -> 0x019c }
            java.lang.String r0 = r0.host()     // Catch:{ all -> 0x019c }
            java.lang.StringBuilder r0 = r3.append(r0)     // Catch:{ all -> 0x019c }
            java.lang.String r3 = " not verified:\n              |    certificate: "
            java.lang.StringBuilder r0 = r0.append(r3)     // Catch:{ all -> 0x019c }
            okhttp3.CertificatePinner$Companion r3 = okhttp3.CertificatePinner.Companion     // Catch:{ all -> 0x019c }
            r4 = r10
            java.security.cert.Certificate r4 = (java.security.cert.Certificate) r4     // Catch:{ all -> 0x019c }
            java.lang.String r3 = r3.pin(r4)     // Catch:{ all -> 0x019c }
            java.lang.StringBuilder r0 = r0.append(r3)     // Catch:{ all -> 0x019c }
            java.lang.String r3 = "\n              |    DN: "
            java.lang.StringBuilder r0 = r0.append(r3)     // Catch:{ all -> 0x019c }
            java.security.Principal r3 = r10.getSubjectDN()     // Catch:{ all -> 0x019c }
            java.lang.String r4 = "cert.subjectDN"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r3, r4)     // Catch:{ all -> 0x019c }
            java.lang.String r3 = r3.getName()     // Catch:{ all -> 0x019c }
            java.lang.StringBuilder r0 = r0.append(r3)     // Catch:{ all -> 0x019c }
            java.lang.String r3 = "\n              |    subjectAltNames: "
            java.lang.StringBuilder r0 = r0.append(r3)     // Catch:{ all -> 0x019c }
            okhttp3.internal.tls.OkHostnameVerifier r3 = okhttp3.internal.tls.OkHostnameVerifier.INSTANCE     // Catch:{ all -> 0x019c }
            java.util.List r10 = r3.allSubjectAltNames(r10)     // Catch:{ all -> 0x019c }
            java.lang.StringBuilder r10 = r0.append(r10)     // Catch:{ all -> 0x019c }
            java.lang.String r0 = "\n              "
            java.lang.StringBuilder r10 = r10.append(r0)     // Catch:{ all -> 0x019c }
            java.lang.String r10 = r10.toString()     // Catch:{ all -> 0x019c }
            java.lang.String r10 = kotlin.text.StringsKt.trimMargin$default(r10, r2, r7, r2)     // Catch:{ all -> 0x019c }
            r11.<init>(r10)     // Catch:{ all -> 0x019c }
            java.lang.Throwable r11 = (java.lang.Throwable) r11     // Catch:{ all -> 0x019c }
            throw r11     // Catch:{ all -> 0x019c }
        L_0x00f8:
            javax.net.ssl.SSLPeerUnverifiedException r10 = new javax.net.ssl.SSLPeerUnverifiedException     // Catch:{ all -> 0x019c }
            java.lang.StringBuilder r11 = new java.lang.StringBuilder     // Catch:{ all -> 0x019c }
            r11.<init>()     // Catch:{ all -> 0x019c }
            java.lang.String r2 = "Hostname "
            java.lang.StringBuilder r11 = r11.append(r2)     // Catch:{ all -> 0x019c }
            okhttp3.HttpUrl r0 = r0.url()     // Catch:{ all -> 0x019c }
            java.lang.String r0 = r0.host()     // Catch:{ all -> 0x019c }
            java.lang.StringBuilder r11 = r11.append(r0)     // Catch:{ all -> 0x019c }
            java.lang.String r0 = " not verified (no certificates)"
            java.lang.StringBuilder r11 = r11.append(r0)     // Catch:{ all -> 0x019c }
            java.lang.String r11 = r11.toString()     // Catch:{ all -> 0x019c }
            r10.<init>(r11)     // Catch:{ all -> 0x019c }
            java.lang.Throwable r10 = (java.lang.Throwable) r10     // Catch:{ all -> 0x019c }
            throw r10     // Catch:{ all -> 0x019c }
        L_0x0121:
            okhttp3.CertificatePinner r3 = r0.certificatePinner()     // Catch:{ all -> 0x019c }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r3)     // Catch:{ all -> 0x019c }
            okhttp3.Handshake r5 = new okhttp3.Handshake     // Catch:{ all -> 0x019c }
            okhttp3.TlsVersion r6 = r4.tlsVersion()     // Catch:{ all -> 0x019c }
            okhttp3.CipherSuite r7 = r4.cipherSuite()     // Catch:{ all -> 0x019c }
            java.util.List r8 = r4.localCertificates()     // Catch:{ all -> 0x019c }
            okhttp3.internal.connection.RealConnection$connectTls$1 r9 = new okhttp3.internal.connection.RealConnection$connectTls$1     // Catch:{ all -> 0x019c }
            r9.<init>(r3, r4, r0)     // Catch:{ all -> 0x019c }
            kotlin.jvm.functions.Function0 r9 = (kotlin.jvm.functions.Function0) r9     // Catch:{ all -> 0x019c }
            r5.<init>(r6, r7, r8, r9)     // Catch:{ all -> 0x019c }
            r10.handshake = r5     // Catch:{ all -> 0x019c }
            okhttp3.HttpUrl r0 = r0.url()     // Catch:{ all -> 0x019c }
            java.lang.String r0 = r0.host()     // Catch:{ all -> 0x019c }
            okhttp3.internal.connection.RealConnection$connectTls$2 r4 = new okhttp3.internal.connection.RealConnection$connectTls$2     // Catch:{ all -> 0x019c }
            r4.<init>(r10)     // Catch:{ all -> 0x019c }
            kotlin.jvm.functions.Function0 r4 = (kotlin.jvm.functions.Function0) r4     // Catch:{ all -> 0x019c }
            r3.check$okhttp(r0, r4)     // Catch:{ all -> 0x019c }
            boolean r11 = r11.supportsTlsExtensions()     // Catch:{ all -> 0x019c }
            if (r11 == 0) goto L_0x0164
            okhttp3.internal.platform.Platform$Companion r11 = okhttp3.internal.platform.Platform.Companion     // Catch:{ all -> 0x019c }
            okhttp3.internal.platform.Platform r11 = r11.get()     // Catch:{ all -> 0x019c }
            java.lang.String r2 = r11.getSelectedProtocol(r1)     // Catch:{ all -> 0x019c }
        L_0x0164:
            r11 = r1
            java.net.Socket r11 = (java.net.Socket) r11     // Catch:{ all -> 0x019c }
            r10.socket = r11     // Catch:{ all -> 0x019c }
            r11 = r1
            java.net.Socket r11 = (java.net.Socket) r11     // Catch:{ all -> 0x019c }
            okio.Source r11 = okio.Okio.source((java.net.Socket) r11)     // Catch:{ all -> 0x019c }
            okio.BufferedSource r11 = okio.Okio.buffer((okio.Source) r11)     // Catch:{ all -> 0x019c }
            r10.source = r11     // Catch:{ all -> 0x019c }
            r11 = r1
            java.net.Socket r11 = (java.net.Socket) r11     // Catch:{ all -> 0x019c }
            okio.Sink r11 = okio.Okio.sink((java.net.Socket) r11)     // Catch:{ all -> 0x019c }
            okio.BufferedSink r11 = okio.Okio.buffer((okio.Sink) r11)     // Catch:{ all -> 0x019c }
            r10.sink = r11     // Catch:{ all -> 0x019c }
            if (r2 == 0) goto L_0x018c
            okhttp3.Protocol$Companion r11 = okhttp3.Protocol.Companion     // Catch:{ all -> 0x019c }
            okhttp3.Protocol r11 = r11.get(r2)     // Catch:{ all -> 0x019c }
            goto L_0x018e
        L_0x018c:
            okhttp3.Protocol r11 = okhttp3.Protocol.HTTP_1_1     // Catch:{ all -> 0x019c }
        L_0x018e:
            r10.protocol = r11     // Catch:{ all -> 0x019c }
        ...
        L_0x019c:
            ...
            goto L_0x01a8
        L_0x019f:
            java.lang.NullPointerException r10 = new java.lang.NullPointerException     // Catch:{ all -> 0x01a7 }
            java.lang.String r11 = "null cannot be cast to non-null type javax.net.ssl.SSLSocket"
            r10.<init>(r11)     // Catch:{ all -> 0x01a7 }
            throw r10     // Catch:{ all -> 0x01a7 }
        L_0x01a7:
            r10 = move-exception
        L_0x01a8:
    ...
    private final Request createTunnelRequest() throws IOException {
        Request build = new Request.Builder().url(this.route.address().url()).method("CONNECT", (RequestBody) null).header("Host", Util.toHostHeader(this.route.address().url(), true)).header("Proxy-Connection", "Keep-Alive").header(DataOkHttpUploaderV2.HEADER_USER_AGENT, Util.userAgent).build();
    ...
    @Metadata(mo20733bv = {1, 0, 3}, mo20734d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J&\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u0004R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\bXT¢\u0006\u0002\n\u0000¨\u0006\u0012"}, mo20735d2 = {"Lokhttp3/internal/connection/RealConnection$Companion;", "", "()V", "IDLE_CONNECTION_HEALTHY_NS", "", "MAX_TUNNEL_ATTEMPTS", "", "NPE_THROW_WITH_NULL", "", "newTestConnection", "Lokhttp3/internal/connection/RealConnection;", "connectionPool", "Lokhttp3/internal/connection/RealConnectionPool;", "route", "Lokhttp3/Route;", "socket", "Ljava/net/Socket;", "idleAtNs", "okhttp"}, mo20736k = 1, mo20737mv = {1, 4, 0})
    /* compiled from: RealConnection.kt */
