...
public final class Http2Stream {
    ...
    public final boolean isLocallyInitiated() {
        if (this.connection.getClient$okhttp() == ((this.f255id & 1) == 1)) {
            return true;
        }
        return false;
    }
    ...
    public final void close(ErrorCode errorCode2, IOException iOException) throws IOException {
        ...
        if (closeInternal(errorCode2, iOException)) {
            this.connection.writeSynReset$okhttp(this.f255id, errorCode2);
        }
    }
    ...
    public final void closeLater(ErrorCode errorCode2) {
        ...
        if (closeInternal(errorCode2, (IOException) null)) {
            this.connection.writeSynResetLater$okhttp(this.f255id, errorCode2);
        }
    }
    ...
    @Metadata(mo20733bv = {1, 0, 3}, mo20734d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u000b\n\u0002\b\t\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0004\u0018\u00002\u00020\u0001B\u0017\b\u0000\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\b\u0010\u001a\u001a\u00020\u001bH\u0016J\u0018\u0010\u001c\u001a\u00020\u00032\u0006\u0010\u001d\u001a\u00020\u000f2\u0006\u0010\u001e\u001a\u00020\u0003H\u0016J\u001d\u0010\u001f\u001a\u00020\u001b2\u0006\u0010 \u001a\u00020!2\u0006\u0010\u001e\u001a\u00020\u0003H\u0000¢\u0006\u0002\b\"J\b\u0010#\u001a\u00020$H\u0016J\u0010\u0010%\u001a\u00020\u001b2\u0006\u0010\u001c\u001a\u00020\u0003H\u0002R\u001a\u0010\u0007\u001a\u00020\u0005X\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\b\u0010\t\"\u0004\b\n\u0010\u000bR\u001a\u0010\u0004\u001a\u00020\u0005X\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\f\u0010\t\"\u0004\b\r\u0010\u000bR\u000e\u0010\u0002\u001a\u00020\u0003X\u0004¢\u0006\u0002\n\u0000R\u0011\u0010\u000e\u001a\u00020\u000f¢\u0006\b\n\u0000\u001a\u0004\b\u0010\u0010\u0011R\u0011\u0010\u0012\u001a\u00020\u000f¢\u0006\b\n\u0000\u001a\u0004\b\u0013\u0010\u0011R\u001c\u0010\u0014\u001a\u0004\u0018\u00010\u0015X\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0016\u0010\u0017\"\u0004\b\u0018\u0010\u0019¨\u0006&"}, mo20735d2 = {"Lokhttp3/internal/http2/Http2Stream$FramingSource;", "Lokio/Source;", "maxByteCount", "", "finished", "", "(Lokhttp3/internal/http2/Http2Stream;JZ)V", "closed", "getClosed$okhttp", "()Z", "setClosed$okhttp", "(Z)V", "getFinished$okhttp", "setFinished$okhttp", "readBuffer", "Lokio/Buffer;", "getReadBuffer", "()Lokio/Buffer;", "receiveBuffer", "getReceiveBuffer", "trailers", "Lokhttp3/Headers;", "getTrailers", "()Lokhttp3/Headers;", "setTrailers", "(Lokhttp3/Headers;)V", "close", "", "read", "sink", "byteCount", "receive", "source", "Lokio/BufferedSource;", "receive$okhttp", "timeout", "Lokio/Timeout;", "updateConnectionFlowControl", "okhttp"}, mo20736k = 1, mo20737mv = {1, 4, 0})
    /* compiled from: Http2Stream.kt */
    ...
    public final class FramingSink implements Sink {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:21:0x0060, code lost:
            if (r10.this$0.getSink$okhttp().finished != false) goto L_0x00c6;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:23:0x006c, code lost:
            if (r10.sendBuffer.size() <= 0) goto L_0x0070;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:27:0x0073, code lost:
            if (r10.trailers == null) goto L_0x0077;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:30:0x0078, code lost:
            if (r4 == false) goto L_0x00a1;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x0082, code lost:
            if (r10.sendBuffer.size() <= 0) goto L_0x0088;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:37:0x00ab, code lost:
            if (r10.sendBuffer.size() <= 0) goto L_0x00c6;
         */
        ...
        public void close() throws java.io.IOException {
            ...
            L_0x003f:
                okhttp3.internal.http2.Http2Stream r0 = okhttp3.internal.http2.Http2Stream.this
                monitor-enter(r0)
                boolean r1 = r10.closed     // Catch:{ all -> 0x00e0 }
                if (r1 == 0) goto L_0x0048
                monitor-exit(r0)
                return
            L_0x0048:
                okhttp3.internal.http2.Http2Stream r1 = okhttp3.internal.http2.Http2Stream.this     // Catch:{ all -> 0x00e0 }
                okhttp3.internal.http2.ErrorCode r1 = r1.getErrorCode$okhttp()     // Catch:{ all -> 0x00e0 }
                r2 = 0
                r3 = 1
            ...
            L_0x0054:
                r1 = r2
            L_0x0055:
                kotlin.Unit r4 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00e0 }
                monitor-exit(r0)
                okhttp3.internal.http2.Http2Stream r0 = okhttp3.internal.http2.Http2Stream.this
            ...
            L_0x00c6:
                okhttp3.internal.http2.Http2Stream r0 = okhttp3.internal.http2.Http2Stream.this
                monitor-enter(r0)
                r10.closed = r3     // Catch:{ all -> 0x00dd }
                kotlin.Unit r1 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00dd }
                monitor-exit(r0)
                okhttp3.internal.http2.Http2Stream r0 = okhttp3.internal.http2.Http2Stream.this
                okhttp3.internal.http2.Http2Connection r0 = r0.getConnection()
                r0.flush()
    ...
    @Metadata(mo20733bv = {1, 0, 3}, mo20734d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, mo20735d2 = {"Lokhttp3/internal/http2/Http2Stream$Companion;", "", "()V", "EMIT_BUFFER_SIZE", "", "okhttp"}, mo20736k = 1, mo20737mv = {1, 4, 0})
    /* compiled from: Http2Stream.kt */
    ...
    @Metadata(mo20733bv = {1, 0, 3}, mo20734d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0006\u0010\u0003\u001a\u00020\u0004J\u0012\u0010\u0005\u001a\u00020\u00062\b\u0010\u0007\u001a\u0004\u0018\u00010\u0006H\u0014J\b\u0010\b\u001a\u00020\u0004H\u0014¨\u0006\t"}, mo20735d2 = {"Lokhttp3/internal/http2/Http2Stream$StreamTimeout;", "Lokio/AsyncTimeout;", "(Lokhttp3/internal/http2/Http2Stream;)V", "exitAndThrowIfTimedOut", "", "newTimeoutException", "Ljava/io/IOException;", "cause", "timedOut", "okhttp"}, mo20736k = 1, mo20737mv = {1, 4, 0})
    /* compiled from: Http2Stream.kt */
    ...
    public final void writeHeaders(List<Header> list, boolean z, boolean z2) throws IOException {
        ...
        if (!Util.assertionsEnabled || !Thread.holdsLock(this)) {
            ...
            this.connection.writeHeaders$okhttp(this.f255id, z, list);
            if (z2) {
    ...
    private final boolean closeInternal(ErrorCode errorCode2, IOException iOException) {
        if (!Util.assertionsEnabled || !Thread.holdsLock(this)) {
            synchronized (this) {
                ...
                notifyAll();
                Unit unit = Unit.INSTANCE;
                this.connection.removeStream$okhttp(this.f255id);
                return true;
            }
        }
        StringBuilder append = new StringBuilder().append("Thread ");
    ...
    public final void receiveHeaders(okhttp3.Headers r3, boolean r4) {
        ...
        L_0x0042:
            monitor-enter(r2)
            boolean r0 = r2.hasResponseHeaders     // Catch:{ all -> 0x0078 }
            r1 = 1
            if (r0 == 0) goto L_0x0051
            if (r4 != 0) goto L_0x004b
            goto L_0x0051
        L_0x004b:
            okhttp3.internal.http2.Http2Stream$FramingSource r0 = r2.source     // Catch:{ all -> 0x0078 }
            r0.setTrailers(r3)     // Catch:{ all -> 0x0078 }
            goto L_0x005a
        L_0x0051:
            r2.hasResponseHeaders = r1     // Catch:{ all -> 0x0078 }
            java.util.ArrayDeque<okhttp3.Headers> r0 = r2.headersQueue     // Catch:{ all -> 0x0078 }
            java.util.Collection r0 = (java.util.Collection) r0     // Catch:{ all -> 0x0078 }
            r0.add(r3)     // Catch:{ all -> 0x0078 }
        L_0x005a:
            if (r4 == 0) goto L_0x0061
            okhttp3.internal.http2.Http2Stream$FramingSource r3 = r2.source     // Catch:{ all -> 0x0078 }
            r3.setFinished$okhttp(r1)     // Catch:{ all -> 0x0078 }
        L_0x0061:
            boolean r3 = r2.isOpen()     // Catch:{ all -> 0x0078 }
            r4 = r2
            java.lang.Object r4 = (java.lang.Object) r4     // Catch:{ all -> 0x0078 }
