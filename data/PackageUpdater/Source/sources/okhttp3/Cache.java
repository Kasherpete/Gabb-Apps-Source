...
public final class Cache implements Closeable, Flushable {
    ...
    public final File m1689deprecated_directory() {
        return this.cache.getDirectory();
    }
    ...
    private static final class Entry {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:21:0x011c, code lost:
            kotlin.p007io.CloseableKt.closeFinally(r10, r9);
         */
        ...
        public final void writeTo(okhttp3.internal.cache.DiskLruCache.Editor r10) throws java.io.IOException {
            ...
            L_0x00ad:
                ...
                r9.writeCertList(r2, r0)     // Catch:{ all -> 0x0119 }
                okhttp3.Handshake r9 = r9.handshake     // Catch:{ all -> 0x0119 }
                okhttp3.TlsVersion r9 = r9.tlsVersion()     // Catch:{ all -> 0x0119 }
                java.lang.String r9 = r9.javaName()     // Catch:{ all -> 0x0119 }
                okio.BufferedSink r9 = r2.writeUtf8(r9)     // Catch:{ all -> 0x0119 }
                r9.writeByte(r4)     // Catch:{ all -> 0x0119 }
            L_0x0113:
                kotlin.Unit r9 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0119 }
                kotlin.p007io.CloseableKt.closeFinally(r10, r1)
                return
            L_0x0119:
                r9 = move-exception
                throw r9     // Catch:{ all -> 0x011b }
            L_0x011b:
                r0 = move-exception
                kotlin.p007io.CloseableKt.closeFinally(r10, r9)
                throw r0
        ...
        @Metadata(mo20733bv = {1, 0, 3}, mo20734d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0006"}, mo20735d2 = {"Lokhttp3/Cache$Entry$Companion;", "", "()V", "RECEIVED_MILLIS", "", "SENT_MILLIS", "okhttp"}, mo20736k = 1, mo20737mv = {1, 4, 0})
        /* compiled from: Cache.kt */
