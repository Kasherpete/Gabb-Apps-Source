...
public final class HttpUrl {
    ...
    public final String encodedQuery() {
        ...
        int indexOf$default = StringsKt.indexOf$default((CharSequence) this.url, (char) TracingInterceptor.URL_QUERY_PARAMS_BLOCK_SEPARATOR, 0, false, 6, (Object) null) + 1;
        String str = this.url;
        int delimiterOffset = Util.delimiterOffset(str, '#', indexOf$default, str.length());
        String str2 = this.url;
        Objects.requireNonNull(str2, "null cannot be cast to non-null type java.lang.String");
    ...
    public static final class Builder {
        ...
        public final Builder scheme(String str) {
            ...
            if (StringsKt.equals(str, DDSpanTypes.HTTP_CLIENT, true)) {
                builder.scheme = DDSpanTypes.HTTP_CLIENT;
        ...
        public final okhttp3.HttpUrl.Builder query(java.lang.String r13) {
            /*
                r12 = this;
                okhttp3.HttpUrl$Builder r12 = (okhttp3.HttpUrl.Builder) r12
                ...
                if (str2 != null) {
                    ...
                    if (list3 != null) {
                        ...
                        for (String str3 : iterable2) {
                            arrayList2.add(str3 != null ? Companion.percentDecode$okhttp$default(HttpUrl.Companion, str3, 0, 0, true, 3, (Object) null) : null);
                        }
                    ...
                    return new HttpUrl(str, percentDecode$okhttp$default, percentDecode$okhttp$default2, str2, effectivePort, list2, list, str4 != null ? Companion.percentDecode$okhttp$default(HttpUrl.Companion, str4, 0, 0, false, 7, (Object) null) : null, toString());
                }
        ...
        public final Builder parse$okhttp(HttpUrl httpUrl, String str) {
            ...
            if (access$schemeDelimiterOffset != -1) {
                if (StringsKt.startsWith(str4, "https:", indexOfFirstNonAsciiWhitespace$default, true)) {
                    ...
                    this.scheme = DDSpanTypes.HTTP_CLIENT;
            ...
            char c2 = TracingInterceptor.URL_QUERY_PARAMS_BLOCK_SEPARATOR;
            char c3 = '#';
            if (access$slashCount >= 2 || httpUrl == null || (!Intrinsics.areEqual((Object) httpUrl.scheme(), (Object) this.scheme))) {
                ...
                while (true) {
                    ...
                    if (charAt == c || charAt == c3 || charAt == '/' || charAt == '\\' || charAt == c2) {
                        ...
                        str5 = str3;
                        c3 = '#';
                        c2 = TracingInterceptor.URL_QUERY_PARAMS_BLOCK_SEPARATOR;
                        c = 65535;
                    }
                }
                boolean z72 = z4;
        ...
        @Metadata(mo20733bv = {1, 0, 3}, mo20734d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0007\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J \u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002J \u0010\n\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002J \u0010\u000b\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002J\u001c\u0010\f\u001a\u00020\u0006*\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\r"}, mo20735d2 = {"Lokhttp3/HttpUrl$Builder$Companion;", "", "()V", "INVALID_HOST", "", "parsePort", "", "input", "pos", "limit", "portColonOffset", "schemeDelimiterOffset", "slashCount", "okhttp"}, mo20736k = 1, mo20737mv = {1, 4, 0})
        /* compiled from: HttpUrl.kt */
    ...
    public static final class Companion {
        ...
        public final int defaultPort(String str) {
            ...
            } else if (str.equals(DDSpanTypes.HTTP_CLIENT)) {
                return 80;
            }
            return -1;
        }
        ...
        public final HttpUrl m1748deprecated_get(String str) {
        ...
        public final HttpUrl m1751deprecated_parse(String str) {
            Intrinsics.checkNotNullParameter(str, "url");
            return parse(str);
        }
        ...
        @Deprecated(level = DeprecationLevel.ERROR, message = "moved to extension function", replaceWith = @ReplaceWith(expression = "url.toHttpUrlOrNull()", imports = {"okhttp3.HttpUrl.Companion.toHttpUrlOrNull"}))
        /* renamed from: -deprecated_get  reason: not valid java name */
        public final HttpUrl m1750deprecated_get(URL url) {
        ...
        /* renamed from: -deprecated_get  reason: not valid java name */
        public final HttpUrl m1749deprecated_get(URI uri) {
