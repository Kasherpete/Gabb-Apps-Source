...
public final class BroadcastReceiverComponentManager {
    public static Object generatedComponent(Context context) {
        ...
        Preconditions.checkArgument(application instanceof GeneratedComponentManager, "Hilt BroadcastReceiver must be attached to an @AndroidEntryPoint Application. Found: %s", application.getClass());
