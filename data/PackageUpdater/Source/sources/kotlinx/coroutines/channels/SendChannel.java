...
public interface SendChannel<E> {
    ...
    Object m1643trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m1631isSuccessimpl(r0)) {
                return true;
            }
            Throwable r02 = ChannelResult.m1625exceptionOrNullimpl(r0);
            if (r02 == null) {
                return false;
            }
