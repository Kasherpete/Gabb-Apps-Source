...
final class TestDispatcher$invokeOnTimeout$1 extends Lambda implements Function1<Runnable, Boolean> {
    public static final TestDispatcher$invokeOnTimeout$1 INSTANCE = new TestDispatcher$invokeOnTimeout$1();

    TestDispatcher$invokeOnTimeout$1() {
        super(1);
    }
