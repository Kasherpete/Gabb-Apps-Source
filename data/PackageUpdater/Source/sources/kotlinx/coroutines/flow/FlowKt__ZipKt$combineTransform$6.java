...
@Metadata(mo20734d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0006\b\u0000\u0010\u0002\u0018\u0001\"\u0004\b\u0001\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u0004H@"}, mo20735d2 = {"<anonymous>", "", "T", "R", "Lkotlinx/coroutines/flow/FlowCollector;"}, mo20736k = 3, mo20737mv = {1, 6, 0}, mo20739xi = 176)
@DebugMetadata(mo21448c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6", mo21449f = "Zip.kt", mo21450i = {}, mo21451l = {251}, mo21452m = "invokeSuspend", mo21453n = {}, mo21454s = {})
...
public final class FlowKt__ZipKt$combineTransform$6 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(mo21448c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2", mo21449f = "Zip.kt", mo21450i = {}, mo21451l = {251}, mo21452m = "invokeSuspend", mo21453n = {}, mo21454s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2 */
    /* compiled from: Zip.kt */
    public static final class C14322 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        /* synthetic */ Object L$1;
        int label;

        public final Object invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C14322 r0 = new C14322(r3, continuation);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            }, new C14322((Continuation<? super C14322>) null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else if (i == 1) {
            ResultKt.throwOnFailure(obj);
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        }, new C14322((Continuation<? super C14322>) null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
