...
@DebugMetadata(mo21448c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7", mo21449f = "Zip.kt", mo21450i = {}, mo21451l = {308}, mo21452m = "invokeSuspend", mo21453n = {}, mo21454s = {})
...
public final class FlowKt__ZipKt$combineTransform$7 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(mo21448c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2", mo21449f = "Zip.kt", mo21450i = {}, mo21451l = {308}, mo21452m = "invokeSuspend", mo21453n = {}, mo21454s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2 */
    /* compiled from: Zip.kt */
    public static final class C14342 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        /* synthetic */ Object L$1;
        int label;

        public final Object invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C14342 r0 = new C14342(r3, continuation);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            }, new C14342((Continuation<? super C14342>) null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else if (i == 1) {
            ResultKt.throwOnFailure(obj);
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        }, new C14342((Continuation<? super C14342>) null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
