...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m1648debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m1601toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> m1649sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m1601toDelayMillisLRDsOJo(j));
    }
}
