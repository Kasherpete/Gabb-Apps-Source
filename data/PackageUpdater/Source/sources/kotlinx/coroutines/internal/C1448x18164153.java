...
public final class C1448x18164153 extends Lambda implements Function1<Throwable, Throwable> {
    final /* synthetic */ Constructor $constructor$inlined;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C1448x18164153(Constructor constructor) {
        super(1);
    ...
    public final Throwable invoke(Throwable th) {
        ...
        try {
            ...
            if (newInstance != null) {
                obj = Result.m176constructorimpl((Throwable) newInstance);
