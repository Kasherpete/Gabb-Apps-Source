...
import androidx.viewpager2.C0741R;
...
public final class ViewPager2 extends ViewGroup {
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        C07562 r3 = new OnPageChangeCallback() {
            public void onPageSelected(int i) {
        ...
        C07573 r4 = new OnPageChangeCallback() {
            public void onPageSelected(int i) {
    ...
    private void setOrientation(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0741R.styleable.ViewPager2);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0741R.styleable.ViewPager2, attributeSet, obtainStyledAttributes, 0, 0);
        }
        try {
            setOrientation(obtainStyledAttributes.getInt(C0741R.styleable.ViewPager2_android_orientation, 0));
        } finally {
