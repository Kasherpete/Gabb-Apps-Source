...
public final class SidecarCompat implements ExtensionInterfaceCompat {
    ...
    private final void registerConfigurationChangeListener(Activity activity) {
        if (this.componentCallbackMap.get(activity) == null) {
            C0766xe5f1d4c7 sidecarCompat$registerConfigurationChangeListener$configChangeObserver$1 = new C0766xe5f1d4c7(this, activity);
    ...
    public boolean validateExtensionInterface() {
        /*
            ...
            r0 = 1
            r1 = 0
            androidx.window.sidecar.SidecarInterface r2 = r7.sidecar     // Catch:{ all -> 0x019c }
            r3 = 0
        ...
        L_0x0086:
            ...
            androidx.window.sidecar.SidecarInterface r7 = r7.sidecar     // Catch:{ all -> 0x019c }
            if (r7 != 0) goto L_0x0094
        L_0x0092:
            r7 = r3
            goto L_0x00a7
        L_0x0094:
            java.lang.Class r7 = r7.getClass()     // Catch:{ all -> 0x019c }
            if (r7 != 0) goto L_0x009b
            goto L_0x0092
        L_0x009b:
            java.lang.String r2 = "onWindowLayoutChangeListenerRemoved"
            java.lang.Class[] r4 = new java.lang.Class[r0]     // Catch:{ all -> 0x019c }
            java.lang.Class<android.os.IBinder> r5 = android.os.IBinder.class
            r4[r1] = r5     // Catch:{ all -> 0x019c }
            java.lang.reflect.Method r7 = r7.getMethod(r2, r4)     // Catch:{ all -> 0x019c }
        L_0x00a7:
            if (r7 != 0) goto L_0x00aa
            goto L_0x00ae
        L_0x00aa:
            java.lang.Class r3 = r7.getReturnType()     // Catch:{ all -> 0x019c }
        L_0x00ae:
            java.lang.Class r7 = java.lang.Void.TYPE     // Catch:{ all -> 0x019c }
            boolean r7 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r3, (java.lang.Object) r7)     // Catch:{ all -> 0x019c }
            if (r7 == 0) goto L_0x016c
            androidx.window.sidecar.SidecarDeviceState r7 = new androidx.window.sidecar.SidecarDeviceState     // Catch:{ all -> 0x019c }
            r7.<init>()     // Catch:{ all -> 0x019c }
            r2 = 3
            r7.posture = r2     // Catch:{ NoSuchFieldError -> 0x00bf }
            goto L_0x00f2
        L_0x00bf:
            ...
            java.lang.Class[] r5 = new java.lang.Class[r0]     // Catch:{ all -> 0x019c }
            java.lang.Class r6 = java.lang.Integer.TYPE     // Catch:{ all -> 0x019c }
            r5[r1] = r6     // Catch:{ all -> 0x019c }
            java.lang.reflect.Method r3 = r3.getMethod(r4, r5)     // Catch:{ all -> 0x019c }
            java.lang.Object[] r4 = new java.lang.Object[r0]     // Catch:{ all -> 0x019c }
            java.lang.Integer r5 = java.lang.Integer.valueOf(r2)     // Catch:{ all -> 0x019c }
            r4[r1] = r5     // Catch:{ all -> 0x019c }
            r3.invoke(r7, r4)     // Catch:{ all -> 0x019c }
            java.lang.Class<androidx.window.sidecar.SidecarDeviceState> r3 = androidx.window.sidecar.SidecarDeviceState.class
            java.lang.String r4 = "getPosture"
            java.lang.Class[] r5 = new java.lang.Class[r1]     // Catch:{ all -> 0x019c }
            java.lang.reflect.Method r3 = r3.getMethod(r4, r5)     // Catch:{ all -> 0x019c }
            java.lang.Object[] r4 = new java.lang.Object[r1]     // Catch:{ all -> 0x019c }
            java.lang.Object r7 = r3.invoke(r7, r4)     // Catch:{ all -> 0x019c }
            if (r7 == 0) goto L_0x0164
            java.lang.Integer r7 = (java.lang.Integer) r7     // Catch:{ all -> 0x019c }
            int r7 = r7.intValue()     // Catch:{ all -> 0x019c }
            if (r7 != r2) goto L_0x015c
        L_0x00f2:
            androidx.window.sidecar.SidecarDisplayFeature r7 = new androidx.window.sidecar.SidecarDisplayFeature     // Catch:{ all -> 0x019c }
            r7.<init>()     // Catch:{ all -> 0x019c }
            android.graphics.Rect r2 = r7.getRect()     // Catch:{ all -> 0x019c }
            java.lang.String r3 = "displayFeature.rect"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r3)     // Catch:{ all -> 0x019c }
            r7.setRect(r2)     // Catch:{ all -> 0x019c }
            r7.getType()     // Catch:{ all -> 0x019c }
            r7.setType(r0)     // Catch:{ all -> 0x019c }
            androidx.window.sidecar.SidecarWindowLayoutInfo r2 = new androidx.window.sidecar.SidecarWindowLayoutInfo     // Catch:{ all -> 0x019c }
            r2.<init>()     // Catch:{ all -> 0x019c }
            java.util.List r7 = r2.displayFeatures     // Catch:{ NoSuchFieldError -> 0x0112 }
            goto L_0x019d
        L_0x0112:
            java.util.ArrayList r3 = new java.util.ArrayList     // Catch:{ all -> 0x019c }
            r3.<init>()     // Catch:{ all -> 0x019c }
            java.util.List r3 = (java.util.List) r3     // Catch:{ all -> 0x019c }
            r3.add(r7)     // Catch:{ all -> 0x019c }
            ...
            r5[r1] = r6     // Catch:{ all -> 0x019c }
            java.lang.reflect.Method r7 = r7.getMethod(r4, r5)     // Catch:{ all -> 0x019c }
            java.lang.Object[] r4 = new java.lang.Object[r0]     // Catch:{ all -> 0x019c }
            r4[r1] = r3     // Catch:{ all -> 0x019c }
            r7.invoke(r2, r4)     // Catch:{ all -> 0x019c }
            java.lang.Class<androidx.window.sidecar.SidecarWindowLayoutInfo> r7 = androidx.window.sidecar.SidecarWindowLayoutInfo.class
            java.lang.String r4 = "getDisplayFeatures"
            java.lang.Class[] r5 = new java.lang.Class[r1]     // Catch:{ all -> 0x019c }
            java.lang.reflect.Method r7 = r7.getMethod(r4, r5)     // Catch:{ all -> 0x019c }
            java.lang.Object[] r4 = new java.lang.Object[r1]     // Catch:{ all -> 0x019c }
            java.lang.Object r7 = r7.invoke(r2, r4)     // Catch:{ all -> 0x019c }
            if (r7 == 0) goto L_0x0154
            java.util.List r7 = (java.util.List) r7     // Catch:{ all -> 0x019c }
            boolean r7 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r3, (java.lang.Object) r7)     // Catch:{ all -> 0x019c }
            if (r7 == 0) goto L_0x014c
            goto L_0x019d
        L_0x014c:
            java.lang.Exception r7 = new java.lang.Exception     // Catch:{ all -> 0x019c }
            java.lang.String r0 = "Invalid display feature getter/setter"
            r7.<init>(r0)     // Catch:{ all -> 0x019c }
            throw r7     // Catch:{ all -> 0x019c }
        L_0x0154:
            java.lang.NullPointerException r7 = new java.lang.NullPointerException     // Catch:{ all -> 0x019c }
        ...
        L_0x0164:
            ...
            throw r7     // Catch:{ all -> 0x019c }
        L_0x016c:
            java.lang.NoSuchMethodException r7 = new java.lang.NoSuchMethodException     // Catch:{ all -> 0x019c }
            java.lang.String r0 = "Illegal return type for 'onWindowLayoutChangeListenerRemoved': "
            java.lang.String r0 = kotlin.jvm.internal.Intrinsics.stringPlus(r0, r3)     // Catch:{ all -> 0x019c }
            r7.<init>(r0)     // Catch:{ all -> 0x019c }
            throw r7     // Catch:{ all -> 0x019c }
        L_0x0178:
            java.lang.NoSuchMethodException r7 = new java.lang.NoSuchMethodException     // Catch:{ all -> 0x019c }
            java.lang.String r0 = "Illegal return type for 'onWindowLayoutChangeListenerAdded': "
            java.lang.String r0 = kotlin.jvm.internal.Intrinsics.stringPlus(r0, r2)     // Catch:{ all -> 0x019c }
            r7.<init>(r0)     // Catch:{ all -> 0x019c }
            throw r7     // Catch:{ all -> 0x019c }
        L_0x0184:
            java.lang.NoSuchMethodException r7 = new java.lang.NoSuchMethodException     // Catch:{ all -> 0x019c }
    ...
    @Metadata(mo20734d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0017J\u0018\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000bH\u0017¨\u0006\f"}, mo20735d2 = {"Landroidx/window/layout/SidecarCompat$TranslatingCallback;", "Landroidx/window/sidecar/SidecarInterface$SidecarCallback;", "(Landroidx/window/layout/SidecarCompat;)V", "onDeviceStateChanged", "", "newDeviceState", "Landroidx/window/sidecar/SidecarDeviceState;", "onWindowLayoutChanged", "windowToken", "Landroid/os/IBinder;", "newLayout", "Landroidx/window/sidecar/SidecarWindowLayoutInfo;", "window_release"}, mo20736k = 1, mo20737mv = {1, 6, 0}, mo20739xi = 48)
    /* compiled from: SidecarCompat.kt */
    ...
    @Metadata(mo20734d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\b\u0002\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0001¢\u0006\u0002\u0010\u0003J\u0018\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\u00062\u0006\u0010\r\u001a\u00020\u0007H\u0016R\u001c\u0010\u0004\u001a\u000e\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u00070\u00058\u0002X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0002\u001a\u00020\u0001X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\tX\u0004¢\u0006\u0002\n\u0000¨\u0006\u000e"}, mo20735d2 = {"Landroidx/window/layout/SidecarCompat$DistinctElementCallback;", "Landroidx/window/layout/ExtensionInterfaceCompat$ExtensionCallbackInterface;", "callbackInterface", "(Landroidx/window/layout/ExtensionInterfaceCompat$ExtensionCallbackInterface;)V", "activityWindowLayoutInfo", "Ljava/util/WeakHashMap;", "Landroid/app/Activity;", "Landroidx/window/layout/WindowLayoutInfo;", "lock", "Ljava/util/concurrent/locks/ReentrantLock;", "onWindowLayoutChanged", "", "activity", "newLayout", "window_release"}, mo20736k = 1, mo20737mv = {1, 6, 0}, mo20739xi = 48)
    /* compiled from: SidecarCompat.kt */
    ...
    @Metadata(mo20734d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\b\u0002\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0001¢\u0006\u0002\u0010\u0005J\u0010\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0010\u001a\u00020\u0007H\u0016J\u0018\u0010\u0011\u001a\u00020\u000f2\u0006\u0010\u0012\u001a\u00020\f2\u0006\u0010\u0013\u001a\u00020\rH\u0016R\u000e\u0010\u0004\u001a\u00020\u0001X\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0006\u001a\u0004\u0018\u00010\u00078\u0002@\u0002X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\tX\u0004¢\u0006\u0002\n\u0000R\u001c\u0010\n\u001a\u000e\u0012\u0004\u0012\u00020\f\u0012\u0004\u0012\u00020\r0\u000b8\u0002X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0002\u001a\u00020\u0003X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0014"}, mo20735d2 = {"Landroidx/window/layout/SidecarCompat$DistinctSidecarElementCallback;", "Landroidx/window/sidecar/SidecarInterface$SidecarCallback;", "sidecarAdapter", "Landroidx/window/layout/SidecarAdapter;", "callbackInterface", "(Landroidx/window/layout/SidecarAdapter;Landroidx/window/sidecar/SidecarInterface$SidecarCallback;)V", "lastDeviceState", "Landroidx/window/sidecar/SidecarDeviceState;", "lock", "Ljava/util/concurrent/locks/ReentrantLock;", "mActivityWindowLayoutInfo", "Ljava/util/WeakHashMap;", "Landroid/os/IBinder;", "Landroidx/window/sidecar/SidecarWindowLayoutInfo;", "onDeviceStateChanged", "", "newDeviceState", "onWindowLayoutChanged", "token", "newLayout", "window_release"}, mo20736k = 1, mo20737mv = {1, 6, 0}, mo20739xi = 48)
    /* compiled from: SidecarCompat.kt */
    private static final class DistinctSidecarElementCallback implements SidecarInterface.SidecarCallback {
        ...
        public void onWindowLayoutChanged(IBinder iBinder, SidecarWindowLayoutInfo sidecarWindowLayoutInfo) {
            Intrinsics.checkNotNullParameter(iBinder, MPDbAdapter.KEY_TOKEN);
            Intrinsics.checkNotNullParameter(sidecarWindowLayoutInfo, "newLayout");
