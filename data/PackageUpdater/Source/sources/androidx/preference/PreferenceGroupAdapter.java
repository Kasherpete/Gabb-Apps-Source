...
public class PreferenceGroupAdapter extends RecyclerView.Adapter<PreferenceViewHolder> implements Preference.OnPreferenceChangeInternalListener, PreferenceGroup.PreferencePositionCallback {
    ...
    public PreferenceViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        TypedArray obtainStyledAttributes = viewGroup.getContext().obtainStyledAttributes((AttributeSet) null, C0526R.styleable.BackgroundStyle);
        Drawable drawable = obtainStyledAttributes.getDrawable(C0526R.styleable.BackgroundStyle_android_selectableItemBackground);
        if (drawable == null) {
