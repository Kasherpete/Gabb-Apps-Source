...
public class SeekBarPreference extends Preference {
    ...
    public SeekBarPreference(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0526R.styleable.SeekBarPreference, i, i2);
        this.mMin = obtainStyledAttributes.getInt(C0526R.styleable.SeekBarPreference_min, 0);
        setMax(obtainStyledAttributes.getInt(C0526R.styleable.SeekBarPreference_android_max, 100));
        setSeekBarIncrement(obtainStyledAttributes.getInt(C0526R.styleable.SeekBarPreference_seekBarIncrement, 0));
        this.mAdjustable = obtainStyledAttributes.getBoolean(C0526R.styleable.SeekBarPreference_adjustable, true);
        this.mShowSeekBarValue = obtainStyledAttributes.getBoolean(C0526R.styleable.SeekBarPreference_showSeekBarValue, false);
        this.mUpdatesContinuously = obtainStyledAttributes.getBoolean(C0526R.styleable.SeekBarPreference_updatesContinuously, false);
    ...
    public SeekBarPreference(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0526R.attr.seekBarPreferenceStyle);
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        this.mSeekBar = (SeekBar) preferenceViewHolder.findViewById(C0526R.C0529id.seekbar);
        TextView textView = (TextView) preferenceViewHolder.findViewById(C0526R.C0529id.seekbar_value);
