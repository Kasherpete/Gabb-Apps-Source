...
public class Preference implements Comparable<Preference> {
    ...
    public Preference(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mLayoutResId = C0526R.C0530layout.preference;
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0526R.styleable.Preference, i, i2);
        this.mIconResId = TypedArrayUtils.getResourceId(obtainStyledAttributes, C0526R.styleable.Preference_icon, C0526R.styleable.Preference_android_icon, 0);
        this.mKey = TypedArrayUtils.getString(obtainStyledAttributes, C0526R.styleable.Preference_key, C0526R.styleable.Preference_android_key);
        this.mTitle = TypedArrayUtils.getText(obtainStyledAttributes, C0526R.styleable.Preference_title, C0526R.styleable.Preference_android_title);
        this.mSummary = TypedArrayUtils.getText(obtainStyledAttributes, C0526R.styleable.Preference_summary, C0526R.styleable.Preference_android_summary);
        this.mOrder = TypedArrayUtils.getInt(obtainStyledAttributes, C0526R.styleable.Preference_order, C0526R.styleable.Preference_android_order, Integer.MAX_VALUE);
        this.mFragment = TypedArrayUtils.getString(obtainStyledAttributes, C0526R.styleable.Preference_fragment, C0526R.styleable.Preference_android_fragment);
        this.mLayoutResId = TypedArrayUtils.getResourceId(obtainStyledAttributes, C0526R.styleable.Preference_layout, C0526R.styleable.Preference_android_layout, C0526R.C0530layout.preference);
        this.mWidgetLayoutResId = TypedArrayUtils.getResourceId(obtainStyledAttributes, C0526R.styleable.Preference_widgetLayout, C0526R.styleable.Preference_android_widgetLayout, 0);
        this.mEnabled = TypedArrayUtils.getBoolean(obtainStyledAttributes, C0526R.styleable.Preference_enabled, C0526R.styleable.Preference_android_enabled, true);
        this.mSelectable = TypedArrayUtils.getBoolean(obtainStyledAttributes, C0526R.styleable.Preference_selectable, C0526R.styleable.Preference_android_selectable, true);
        this.mPersistent = TypedArrayUtils.getBoolean(obtainStyledAttributes, C0526R.styleable.Preference_persistent, C0526R.styleable.Preference_android_persistent, true);
        this.mDependencyKey = TypedArrayUtils.getString(obtainStyledAttributes, C0526R.styleable.Preference_dependency, C0526R.styleable.Preference_android_dependency);
        this.mAllowDividerAbove = TypedArrayUtils.getBoolean(obtainStyledAttributes, C0526R.styleable.Preference_allowDividerAbove, C0526R.styleable.Preference_allowDividerAbove, this.mSelectable);
        this.mAllowDividerBelow = TypedArrayUtils.getBoolean(obtainStyledAttributes, C0526R.styleable.Preference_allowDividerBelow, C0526R.styleable.Preference_allowDividerBelow, this.mSelectable);
        if (obtainStyledAttributes.hasValue(C0526R.styleable.Preference_defaultValue)) {
            this.mDefaultValue = onGetDefaultValue(obtainStyledAttributes, C0526R.styleable.Preference_defaultValue);
        } else if (obtainStyledAttributes.hasValue(C0526R.styleable.Preference_android_defaultValue)) {
            this.mDefaultValue = onGetDefaultValue(obtainStyledAttributes, C0526R.styleable.Preference_android_defaultValue);
        }
        this.mShouldDisableView = TypedArrayUtils.getBoolean(obtainStyledAttributes, C0526R.styleable.Preference_shouldDisableView, C0526R.styleable.Preference_android_shouldDisableView, true);
        boolean hasValue = obtainStyledAttributes.hasValue(C0526R.styleable.Preference_singleLineTitle);
        this.mHasSingleLineTitleAttr = hasValue;
        if (hasValue) {
            this.mSingleLineTitle = TypedArrayUtils.getBoolean(obtainStyledAttributes, C0526R.styleable.Preference_singleLineTitle, C0526R.styleable.Preference_android_singleLineTitle, true);
        }
        this.mIconSpaceReserved = TypedArrayUtils.getBoolean(obtainStyledAttributes, C0526R.styleable.Preference_iconSpaceReserved, C0526R.styleable.Preference_android_iconSpaceReserved, false);
        this.mVisible = TypedArrayUtils.getBoolean(obtainStyledAttributes, C0526R.styleable.Preference_isPreferenceVisible, C0526R.styleable.Preference_isPreferenceVisible, true);
        this.mCopyingEnabled = TypedArrayUtils.getBoolean(obtainStyledAttributes, C0526R.styleable.Preference_enableCopying, C0526R.styleable.Preference_enableCopying, false);
    ...
    public Preference(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, TypedArrayUtils.getAttr(context, C0526R.attr.preferenceStyle, 16842894));
    }
    ...
    public void onBindViewHolder(androidx.preference.PreferenceViewHolder r9) {
        ...
        L_0x00ab:
            r1.setVisibility(r6)
        L_0x00ae:
            int r1 = androidx.preference.C0526R.C0529id.icon_frame
            android.view.View r1 = r9.findViewById(r1)
    ...
    private static class OnPreferenceCopyListener implements View.OnCreateContextMenuListener, MenuItem.OnMenuItemClickListener {
        ...
        public void onCreateContextMenu(ContextMenu contextMenu, View view, ContextMenu.ContextMenuInfo contextMenuInfo) {
            ...
            if (this.mPreference.isCopyingEnabled() && !TextUtils.isEmpty(summary)) {
                ...
                contextMenu.add(0, 0, 0, C0526R.string.copy).setOnMenuItemClickListener(this);
            }
        }
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            ...
            Toast.makeText(this.mPreference.getContext(), this.mPreference.getContext().getString(C0526R.string.preference_copied, new Object[]{summary}), 0).show();
            return true;
        }
    }
}
