...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<SwitchCompat> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mShowTextId = propertyMapper.mapBoolean("showText", C0026R.attr.showText);
            this.mSplitTrackId = propertyMapper.mapBoolean("splitTrack", C0026R.attr.splitTrack);
            this.mSwitchMinWidthId = propertyMapper.mapInt("switchMinWidth", C0026R.attr.switchMinWidth);
            this.mSwitchPaddingId = propertyMapper.mapInt("switchPadding", C0026R.attr.switchPadding);
            this.mThumbTextPaddingId = propertyMapper.mapInt("thumbTextPadding", C0026R.attr.thumbTextPadding);
            this.mThumbTintId = propertyMapper.mapObject("thumbTint", C0026R.attr.thumbTint);
            this.mThumbTintModeId = propertyMapper.mapObject("thumbTintMode", C0026R.attr.thumbTintMode);
            this.mTrackId = propertyMapper.mapObject("track", C0026R.attr.track);
            this.mTrackTintId = propertyMapper.mapObject("trackTint", C0026R.attr.trackTint);
            this.mTrackTintModeId = propertyMapper.mapObject("trackTintMode", C0026R.attr.trackTintMode);
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0026R.attr.switchStyle);
    }
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0026R.styleable.SwitchCompat, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0026R.styleable.SwitchCompat, attributeSet, obtainStyledAttributes.getWrappedTypeArray(), i, 0);
        Drawable drawable = obtainStyledAttributes.getDrawable(C0026R.styleable.SwitchCompat_android_thumb);
        this.mThumbDrawable = drawable;
        if (drawable != null) {
            drawable.setCallback(this);
        }
        Drawable drawable2 = obtainStyledAttributes.getDrawable(C0026R.styleable.SwitchCompat_track);
        this.mTrackDrawable = drawable2;
        if (drawable2 != null) {
            drawable2.setCallback(this);
        }
        setTextOnInternal(obtainStyledAttributes.getText(C0026R.styleable.SwitchCompat_android_textOn));
        setTextOffInternal(obtainStyledAttributes.getText(C0026R.styleable.SwitchCompat_android_textOff));
        this.mShowText = obtainStyledAttributes.getBoolean(C0026R.styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = obtainStyledAttributes.getDimensionPixelSize(C0026R.styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = obtainStyledAttributes.getDimensionPixelSize(C0026R.styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = obtainStyledAttributes.getDimensionPixelSize(C0026R.styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = obtainStyledAttributes.getBoolean(C0026R.styleable.SwitchCompat_splitTrack, false);
        ColorStateList colorStateList = obtainStyledAttributes.getColorStateList(C0026R.styleable.SwitchCompat_thumbTint);
        if (colorStateList != null) {
            this.mThumbTintList = colorStateList;
            this.mHasThumbTint = true;
        }
        PorterDuff.Mode parseTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0026R.styleable.SwitchCompat_thumbTintMode, -1), (PorterDuff.Mode) null);
        ...
        ColorStateList colorStateList2 = obtainStyledAttributes.getColorStateList(C0026R.styleable.SwitchCompat_trackTint);
        if (colorStateList2 != null) {
            this.mTrackTintList = colorStateList2;
            this.mHasTrackTint = true;
        }
        PorterDuff.Mode parseTintMode2 = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0026R.styleable.SwitchCompat_trackTintMode, -1), (PorterDuff.Mode) null);
        ...
        int resourceId = obtainStyledAttributes.getResourceId(C0026R.styleable.SwitchCompat_switchTextAppearance, 0);
        if (resourceId != 0) {
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        ...
        ColorStateList colorStateList = obtainStyledAttributes.getColorStateList(C0026R.styleable.TextAppearance_android_textColor);
        if (colorStateList != null) {
            this.mTextColors = colorStateList;
        } else {
            this.mTextColors = getTextColors();
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0026R.styleable.TextAppearance_android_textSize, 0);
        ...
        setSwitchTypefaceByIndex(obtainStyledAttributes.getInt(C0026R.styleable.TextAppearance_android_typeface, -1), obtainStyledAttributes.getInt(C0026R.styleable.TextAppearance_android_textStyle, -1));
        if (obtainStyledAttributes.getBoolean(C0026R.styleable.TextAppearance_textAllCaps, false)) {
    ...
    private void setOnStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (charSequence == null) {
                charSequence = getResources().getString(C0026R.string.abc_capital_on);
            }
    ...
    private void setOffStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (charSequence == null) {
                charSequence = getResources().getString(C0026R.string.abc_capital_off);
            }
            ViewCompat.setStateDescription(this, charSequence);
        }
    }
