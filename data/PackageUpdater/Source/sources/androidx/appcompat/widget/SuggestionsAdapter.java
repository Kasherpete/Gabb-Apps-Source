...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) newView.findViewById(C0026R.C0029id.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0026R.C0029id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mProviderContext.getTheme().resolveAttribute(C0026R.attr.textColorSearchUrl, typedValue, true);
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        if (str == null || str.isEmpty() || TracingInterceptor.DROP_SAMPLING_DECISION.equals(str)) {
            return null;
        }
        try {
    ...
    private android.graphics.drawable.Drawable getDrawable(android.net.Uri r6) {
        /*
            ...
            r2 = 0
            java.lang.String r3 = r6.getScheme()     // Catch:{ FileNotFoundException -> 0x008d }
            ...
            return r5
        L_0x0016:
            java.io.FileNotFoundException r5 = new java.io.FileNotFoundException     // Catch:{ FileNotFoundException -> 0x008d }
            java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ FileNotFoundException -> 0x008d }
            r0.<init>()     // Catch:{ FileNotFoundException -> 0x008d }
            java.lang.String r3 = "Resource does not exist: "
            java.lang.StringBuilder r0 = r0.append(r3)     // Catch:{ FileNotFoundException -> 0x008d }
            java.lang.StringBuilder r0 = r0.append(r6)     // Catch:{ FileNotFoundException -> 0x008d }
            java.lang.String r0 = r0.toString()     // Catch:{ FileNotFoundException -> 0x008d }
            r5.<init>(r0)     // Catch:{ FileNotFoundException -> 0x008d }
            throw r5     // Catch:{ FileNotFoundException -> 0x008d }
        L_0x002f:
            android.content.Context r5 = r5.mProviderContext     // Catch:{ FileNotFoundException -> 0x008d }
            android.content.ContentResolver r5 = r5.getContentResolver()     // Catch:{ FileNotFoundException -> 0x008d }
            java.io.InputStream r5 = r5.openInputStream(r6)     // Catch:{ FileNotFoundException -> 0x008d }
            if (r5 == 0) goto L_0x0074
            android.graphics.drawable.Drawable r3 = android.graphics.drawable.Drawable.createFromStream(r5, r2)     // Catch:{ all -> 0x0059 }
            r5.close()     // Catch:{ IOException -> 0x0043 }
            goto L_0x0058
        L_0x0043:
            r5 = move-exception
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ FileNotFoundException -> 0x008d }
            r4.<init>()     // Catch:{ FileNotFoundException -> 0x008d }
            java.lang.StringBuilder r0 = r4.append(r0)     // Catch:{ FileNotFoundException -> 0x008d }
            java.lang.StringBuilder r0 = r0.append(r6)     // Catch:{ FileNotFoundException -> 0x008d }
            java.lang.String r0 = r0.toString()     // Catch:{ FileNotFoundException -> 0x008d }
            android.util.Log.e(r1, r0, r5)     // Catch:{ FileNotFoundException -> 0x008d }
        L_0x0058:
            return r3
        L_0x0059:
            r3 = move-exception
        ...
        L_0x005e:
            ...
            android.util.Log.e(r1, r0, r5)     // Catch:{ FileNotFoundException -> 0x008d }
        L_0x0073:
            throw r3     // Catch:{ FileNotFoundException -> 0x008d }
        L_0x0074:
            java.io.FileNotFoundException r5 = new java.io.FileNotFoundException     // Catch:{ FileNotFoundException -> 0x008d }
            java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ FileNotFoundException -> 0x008d }
            r0.<init>()     // Catch:{ FileNotFoundException -> 0x008d }
