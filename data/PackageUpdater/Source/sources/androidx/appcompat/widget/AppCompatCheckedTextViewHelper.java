...
class AppCompatCheckedTextViewHelper {
    ...
    public void loadFromAttributes(android.util.AttributeSet r11, int r12) {
        /*
            ...
            int[] r1 = androidx.appcompat.C0026R.styleable.CheckedTextView
            r2 = 0
            ...
            int[] r5 = androidx.appcompat.C0026R.styleable.CheckedTextView
            ...
            int r11 = androidx.appcompat.C0026R.styleable.CheckedTextView_checkMarkCompat     // Catch:{ all -> 0x008e }
        ...
        L_0x003f:
            ...
            int r11 = androidx.appcompat.C0026R.styleable.CheckedTextView_android_checkMark     // Catch:{ all -> 0x008e }
            boolean r11 = r0.hasValue(r11)     // Catch:{ all -> 0x008e }
            if (r11 == 0) goto L_0x005e
            int r11 = androidx.appcompat.C0026R.styleable.CheckedTextView_android_checkMark     // Catch:{ all -> 0x008e }
            int r11 = r0.getResourceId(r11, r2)     // Catch:{ all -> 0x008e }
        ...
        L_0x005e:
            int r11 = androidx.appcompat.C0026R.styleable.CheckedTextView_checkMarkTint     // Catch:{ all -> 0x008e }
            boolean r11 = r0.hasValue(r11)     // Catch:{ all -> 0x008e }
            if (r11 == 0) goto L_0x0071
            android.widget.CheckedTextView r11 = r10.mView     // Catch:{ all -> 0x008e }
            int r12 = androidx.appcompat.C0026R.styleable.CheckedTextView_checkMarkTint     // Catch:{ all -> 0x008e }
        ...
        L_0x0071:
            int r11 = androidx.appcompat.C0026R.styleable.CheckedTextView_checkMarkTintMode     // Catch:{ all -> 0x008e }
            boolean r11 = r0.hasValue(r11)     // Catch:{ all -> 0x008e }
