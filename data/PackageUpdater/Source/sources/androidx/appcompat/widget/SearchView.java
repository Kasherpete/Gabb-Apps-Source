...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<SearchView> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mIconifiedByDefaultId = propertyMapper.mapBoolean("iconifiedByDefault", C0026R.attr.iconifiedByDefault);
            this.mQueryHintId = propertyMapper.mapObject("queryHint", C0026R.attr.queryHint);
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0026R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        C01115 r8 = new View.OnClickListener() {
        ...
        C01137 r9 = new TextView.OnEditorActionListener() {
        ...
        C01148 r10 = new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                SearchView.this.onItemClicked(i, 0, (String) null);
            }
        };
        this.mOnItemClickListener = r10;
        C01159 r11 = new AdapterView.OnItemSelectedListener() {
        ...
        int i2 = i;
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet2, C0026R.styleable.SearchView, i2, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0026R.styleable.SearchView, attributeSet2, obtainStyledAttributes.getWrappedTypeArray(), i2, 0);
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(C0026R.styleable.SearchView_layout, C0026R.C0031layout.abc_search_view), this, true);
        SearchAutoComplete searchAutoComplete = (SearchAutoComplete) findViewById(C0026R.C0029id.search_src_text);
        this.mSearchSrcTextView = searchAutoComplete;
        searchAutoComplete.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0026R.C0029id.search_edit_frame);
        View findViewById = findViewById(C0026R.C0029id.search_plate);
        this.mSearchPlate = findViewById;
        View findViewById2 = findViewById(C0026R.C0029id.submit_area);
        this.mSubmitArea = findViewById2;
        ImageView imageView = (ImageView) findViewById(C0026R.C0029id.search_button);
        this.mSearchButton = imageView;
        ImageView imageView2 = (ImageView) findViewById(C0026R.C0029id.search_go_btn);
        this.mGoButton = imageView2;
        ImageView imageView3 = (ImageView) findViewById(C0026R.C0029id.search_close_btn);
        this.mCloseButton = imageView3;
        ImageView imageView4 = (ImageView) findViewById(C0026R.C0029id.search_voice_btn);
        this.mVoiceButton = imageView4;
        ImageView imageView5 = (ImageView) findViewById(C0026R.C0029id.search_mag_icon);
        this.mCollapsedIcon = imageView5;
        ViewCompat.setBackground(findViewById, obtainStyledAttributes.getDrawable(C0026R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(findViewById2, obtainStyledAttributes.getDrawable(C0026R.styleable.SearchView_submitBackground));
        imageView.setImageDrawable(obtainStyledAttributes.getDrawable(C0026R.styleable.SearchView_searchIcon));
        imageView2.setImageDrawable(obtainStyledAttributes.getDrawable(C0026R.styleable.SearchView_goIcon));
        imageView3.setImageDrawable(obtainStyledAttributes.getDrawable(C0026R.styleable.SearchView_closeIcon));
        imageView4.setImageDrawable(obtainStyledAttributes.getDrawable(C0026R.styleable.SearchView_voiceIcon));
        imageView5.setImageDrawable(obtainStyledAttributes.getDrawable(C0026R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = obtainStyledAttributes.getDrawable(C0026R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(imageView, getResources().getString(C0026R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = obtainStyledAttributes.getResourceId(C0026R.styleable.SearchView_suggestionRowLayout, C0026R.C0031layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = obtainStyledAttributes.getResourceId(C0026R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(obtainStyledAttributes.getBoolean(C0026R.styleable.SearchView_iconifiedByDefault, true));
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0026R.styleable.SearchView_android_maxWidth, -1);
        if (dimensionPixelSize != -1) {
            setMaxWidth(dimensionPixelSize);
        }
        this.mDefaultQueryHint = obtainStyledAttributes.getText(C0026R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = obtainStyledAttributes.getText(C0026R.styleable.SearchView_queryHint);
        int i3 = obtainStyledAttributes.getInt(C0026R.styleable.SearchView_android_imeOptions, -1);
        if (i3 != -1) {
            setImeOptions(i3);
        }
        int i4 = obtainStyledAttributes.getInt(C0026R.styleable.SearchView_android_inputType, -1);
        if (i4 != -1) {
            setInputType(i4);
        }
        setFocusable(obtainStyledAttributes.getBoolean(C0026R.styleable.SearchView_android_focusable, true));
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0026R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0026R.dimen.abc_search_view_preferred_height);
    }
    ...
    public void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0026R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(C0026R.dimen.abc_dropdownitem_text_padding_left) : 0;
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C0026R.attr.autoCompleteTextViewStyle);
        }
