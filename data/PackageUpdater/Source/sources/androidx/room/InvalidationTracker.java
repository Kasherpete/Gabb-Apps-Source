    ...
    public InvalidationTracker(RoomDatabase roomDatabase, Map<String, String> map, Map<String, Set<String>> map2, String... strArr) {
        ...
        this.mRefreshRunnable = new Runnable() {
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:38:0x009d, code lost:
                if (r5.this$0.mAutoCloser == null) goto L_0x00a0;
             */
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:45:?, code lost:
                r5 = r5.this$0.mObserverMap.iterator();
             */
            /* JADX WARNING: Code restructure failed: missing block: B:47:0x00b9, code lost:
                if (r5.hasNext() == false) goto L_0x00cb;
             */
            /* JADX WARNING: Code restructure failed: missing block: B:48:0x00bb, code lost:
                ((androidx.room.InvalidationTracker.ObserverWrapper) r5.next().getValue()).notifyByTableInvalidStatus(r1);
             */
            ...
            public void run() {
                /*
                    ...
                    r0.lock()
                    r1 = 0
                    androidx.room.InvalidationTracker r2 = androidx.room.InvalidationTracker.this     // Catch:{ SQLiteException | IllegalStateException -> 0x008e }
                    boolean r2 = r2.ensureInitialization()     // Catch:{ SQLiteException | IllegalStateException -> 0x008e }
                    if (r2 != 0) goto L_0x0025
                    r0.unlock()
                    androidx.room.InvalidationTracker r0 = androidx.room.InvalidationTracker.this
                    androidx.room.AutoCloser r0 = r0.mAutoCloser
                    if (r0 == 0) goto L_0x0024
                    androidx.room.InvalidationTracker r5 = androidx.room.InvalidationTracker.this
                    androidx.room.AutoCloser r5 = r5.mAutoCloser
                    r5.decrementCountAndScheduleClose()
                L_0x0024:
                    return
                L_0x0025:
                    androidx.room.InvalidationTracker r2 = androidx.room.InvalidationTracker.this     // Catch:{ SQLiteException | IllegalStateException -> 0x008e }
                    java.util.concurrent.atomic.AtomicBoolean r2 = r2.mPendingRefresh     // Catch:{ SQLiteException | IllegalStateException -> 0x008e }
                    r3 = 1
                    r4 = 0
                    boolean r2 = r2.compareAndSet(r3, r4)     // Catch:{ SQLiteException | IllegalStateException -> 0x008e }
                ...
                L_0x0042:
                    androidx.room.InvalidationTracker r2 = androidx.room.InvalidationTracker.this     // Catch:{ SQLiteException | IllegalStateException -> 0x008e }
                    androidx.room.RoomDatabase r2 = r2.mDatabase     // Catch:{ SQLiteException | IllegalStateException -> 0x008e }
                ...
                L_0x005d:
                    androidx.room.InvalidationTracker r2 = androidx.room.InvalidationTracker.this     // Catch:{ SQLiteException | IllegalStateException -> 0x008e }
                    androidx.room.RoomDatabase r2 = r2.mDatabase     // Catch:{ SQLiteException | IllegalStateException -> 0x008e }
                    androidx.sqlite.db.SupportSQLiteOpenHelper r2 = r2.getOpenHelper()     // Catch:{ SQLiteException | IllegalStateException -> 0x008e }
                    androidx.sqlite.db.SupportSQLiteDatabase r2 = r2.getWritableDatabase()     // Catch:{ SQLiteException | IllegalStateException -> 0x008e }
                    r2.beginTransactionNonExclusive()     // Catch:{ SQLiteException | IllegalStateException -> 0x008e }
                    java.util.Set r1 = r5.checkUpdatedTable()     // Catch:{ all -> 0x0087 }
                    r2.setTransactionSuccessful()     // Catch:{ all -> 0x0087 }
                    r2.endTransaction()     // Catch:{ SQLiteException | IllegalStateException -> 0x008e }
                    r0.unlock()
                    androidx.room.InvalidationTracker r0 = androidx.room.InvalidationTracker.this
                    androidx.room.AutoCloser r0 = r0.mAutoCloser
                ...
                L_0x00a0:
                    ...
                    monitor-enter(r0)
                    androidx.room.InvalidationTracker r5 = androidx.room.InvalidationTracker.this     // Catch:{ all -> 0x00cd }
                    androidx.arch.core.internal.SafeIterableMap<androidx.room.InvalidationTracker$Observer, androidx.room.InvalidationTracker$ObserverWrapper> r5 = r5.mObserverMap     // Catch:{ all -> 0x00cd }
                    java.util.Iterator r5 = r5.iterator()     // Catch:{ all -> 0x00cd }
                L_0x00b5:
                    boolean r2 = r5.hasNext()     // Catch:{ all -> 0x00cd }
                    if (r2 == 0) goto L_0x00cb
                    java.lang.Object r2 = r5.next()     // Catch:{ all -> 0x00cd }
                    java.util.Map$Entry r2 = (java.util.Map.Entry) r2     // Catch:{ all -> 0x00cd }
                    java.lang.Object r2 = r2.getValue()     // Catch:{ all -> 0x00cd }
                    androidx.room.InvalidationTracker$ObserverWrapper r2 = (androidx.room.InvalidationTracker.ObserverWrapper) r2     // Catch:{ all -> 0x00cd }
                    r2.notifyByTableInvalidStatus(r1)     // Catch:{ all -> 0x00cd }
                    goto L_0x00b5
                L_0x00cb:
                ...
                L_0x00e1:
                    throw r1
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.room.InvalidationTracker.C06271.run():void");
            }
