...
public class DBUtil {
    ...
    private static String processForeignKeyCheckFailure(Cursor cursor) {
        ...
        sb.append("Foreign key violation(s) detected in '").append(str).append("'.\n");
        sb.append("Number of different violations discovered: ").append(hashMap.keySet().size()).append("\n");
        sb.append("Number of rows in violation: ").append(count).append("\n");
