...
final class AutoCloser {
    ...
    final Runnable mAutoCloser = new Runnable() {
        ...
        public void run() {
            ...
            L_0x0049:
                androidx.room.AutoCloser r5 = androidx.room.AutoCloser.this     // Catch:{ all -> 0x0058 }
                r1 = 0
                r5.mDelegateDatabase = r1     // Catch:{ all -> 0x0058 }
            L_0x004e:
                monitor-exit(r0)     // Catch:{ all -> 0x0058 }
                return
            L_0x0050:
                java.lang.IllegalStateException r5 = new java.lang.IllegalStateException     // Catch:{ all -> 0x0058 }
                java.lang.String r1 = "mOnAutoCloseCallback is null but it should have been set before use. Please file a bug against Room at: https://issuetracker.google.com/issues/new?component=413107&template=1096568"
            ...
            L_0x0058:
                ...
                throw r5
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.room.AutoCloser.C05942.run():void");
        }
    };
