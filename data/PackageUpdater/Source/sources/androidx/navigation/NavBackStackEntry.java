    ...
    static /* synthetic */ class C04561 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.navigation.NavBackStackEntry.C04561.<clinit>():void");
        }
    }

    private static Lifecycle.State getStateAfter(Lifecycle.Event event) {
        switch (C04561.$SwitchMap$androidx$lifecycle$Lifecycle$Event[event.ordinal()]) {
            case 1:
            case 2:
