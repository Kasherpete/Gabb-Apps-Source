...
public final class DialogFragmentNavigator extends Navigator<Destination> {
    ...
    public boolean popBackStack() {
        ...
        StringBuilder append = new StringBuilder().append(DIALOG_TAG);
        int i = this.mDialogCount - 1;
        this.mDialogCount = i;
        Fragment findFragmentByTag = fragmentManager.findFragmentByTag(append.append(i).toString());
    ...
    public NavDestination navigate(Destination destination, Bundle bundle, NavOptions navOptions, Navigator.Extras extras) {
        ...
        if (DialogFragment.class.isAssignableFrom(instantiate.getClass())) {
            ...
            dialogFragment.show(fragmentManager, append.append(i).toString());
            return destination;
        }
    ...
    public static class Destination extends NavDestination implements FloatingWindow {
        ...
        public void onInflate(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0492R.styleable.DialogFragmentNavigator);
            String string = obtainAttributes.getString(C0492R.styleable.DialogFragmentNavigator_android_name);
            if (string != null) {
                setClassName(string);
            }
