...
import androidx.navigation.C0476R;
...
public class NavHostFragment extends Fragment implements NavHost {
    ...
    private int getContainerId() {
        int id = getId();
        if (id == 0 || id == -1) {
            return C0492R.C0495id.nav_host_fragment_container;
        }
        return id;
    }
    ...
    public void onInflate(Context context, AttributeSet attributeSet, Bundle bundle) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0476R.styleable.NavHost);
        int resourceId = obtainStyledAttributes.getResourceId(C0476R.styleable.NavHost_navGraph, 0);
        if (resourceId != 0) {
            this.mGraphId = resourceId;
        }
        obtainStyledAttributes.recycle();
        TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C0492R.styleable.NavHostFragment);
        if (obtainStyledAttributes2.getBoolean(C0492R.styleable.NavHostFragment_defaultNavHost, false)) {
            this.mDefaultNavHost = true;
        }
