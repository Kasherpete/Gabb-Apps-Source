...
class SystemJobInfoConverter {
    ...
    public JobInfo convert(WorkSpec workSpec, int i) {
        ...
        persistableBundle.putString(EXTRA_WORK_SPEC_ID, workSpec.f92id);
    ...
    static /* synthetic */ class C07951 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.work.impl.background.systemjob.SystemJobInfoConverter.C07951.<clinit>():void");
        }
    }

    static int convertNetworkType(NetworkType networkType) {
        int i = C07951.$SwitchMap$androidx$work$NetworkType[networkType.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
