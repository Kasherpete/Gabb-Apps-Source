                ...
                TaskExecutor.this.executeOnBackgroundThread(new Runnable() {
                    public void run() {
                        synchronized (obj) {
                            ...
                            if (C08331.this.mCurrentOutput == null && apply != null) {
                                C08331.this.mCurrentOutput = apply;
                                mediatorLiveData.postValue(apply);
                            } else if (C08331.this.mCurrentOutput != null && !C08331.this.mCurrentOutput.equals(apply)) {
                                C08331.this.mCurrentOutput = apply;
                                mediatorLiveData.postValue(apply);
                            }
                        }
