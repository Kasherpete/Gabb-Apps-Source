...
public class WorkTypeConverters {
    ...
    public static int stateToInt(WorkInfo.State state) {
        switch (C08281.$SwitchMap$androidx$work$WorkInfo$State[state.ordinal()]) {
            case 1:
                return 0;
            case 2:
                return 1;
    ...
    public static int backoffPolicyToInt(BackoffPolicy backoffPolicy) {
        int i = C08281.$SwitchMap$androidx$work$BackoffPolicy[backoffPolicy.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
    ...
    public static int networkTypeToInt(NetworkType networkType) {
        int i = C08281.$SwitchMap$androidx$work$NetworkType[networkType.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
    ...
    static /* synthetic */ class C08281 {
        ...
        static {
            ...
            L_0x00b8:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.work.impl.model.WorkTypeConverters.C08281.<clinit>():void");
        }
    }

    public static int outOfQuotaPolicyToInt(OutOfQuotaPolicy outOfQuotaPolicy) {
        int i = C08281.$SwitchMap$androidx$work$OutOfQuotaPolicy[outOfQuotaPolicy.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
