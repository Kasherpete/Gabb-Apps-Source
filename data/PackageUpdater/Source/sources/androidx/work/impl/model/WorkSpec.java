...
public final class WorkSpec {
    ...
    public int hashCode() {
        int hashCode = ((((this.f92id.hashCode() * 31) + this.state.hashCode()) * 31) + this.workerClassName.hashCode()) * 31;
        String str = this.inputMergerClassName;
    ...
    public static class IdAndState {
        ...
        public boolean equals(Object obj) {
            ...
            return this.f93id.equals(idAndState.f93id);
        }

        public int hashCode() {
            return (this.f93id.hashCode() * 31) + this.state.hashCode();
        }
    }
    ...
    public static class WorkInfoPojo {
        ...
        public WorkInfo toWorkInfo() {
            ...
            return new WorkInfo(UUID.fromString(this.f94id), this.state, this.output, this.tags, data, this.runAttemptCount);
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (str == null ? workInfoPojo.f94id != null : !str.equals(workInfoPojo.f94id)) {
                return false;
            }
