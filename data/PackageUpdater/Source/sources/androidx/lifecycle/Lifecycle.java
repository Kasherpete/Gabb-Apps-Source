...
public abstract class Lifecycle {
    ...
    public enum Event {
        ...
        public static Event downFrom(State state) {
            int i = C04131.$SwitchMap$androidx$lifecycle$Lifecycle$State[state.ordinal()];
            if (i == 1) {
                return ON_DESTROY;
            }
            if (i == 2) {
        ...
        public State getTargetState() {
            switch (C04131.$SwitchMap$androidx$lifecycle$Lifecycle$Event[ordinal()]) {
                case 1:
                case 2:
    ...
    static /* synthetic */ class C04131 {
        ...
        static {
            ...
            L_0x008d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.lifecycle.Lifecycle.C04131.<clinit>():void");
        }
    }
