...
public class BarrierReference extends HelperReference {
    ...
    public void apply() {
        getHelperWidget();
        int i = 0;
        switch (C01511.f33xf452c4aa[this.mDirection.ordinal()]) {
            case 3:
            case 4:
                i = 1;
                break;
    ...
    static /* synthetic */ class C01511 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.solver.state.helpers.BarrierReference.C01511.<clinit>():void");
        }
    }
}
