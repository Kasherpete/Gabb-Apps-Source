    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        if (!hashSet2.isEmpty()) {
            ...
            while (it2.hasNext()) {
                ...
                if (str.startsWith("CUSTOM,")) {
                    ...
                    String str2 = str.split(WebViewLogEventConsumer.DDTAGS_SEPARATOR)[c];
            ...
            while (it5.hasNext()) {
                ...
                if (!this.mTimeCycleAttributesMap.containsKey(str3)) {
                    if (str3.startsWith("CUSTOM,")) {
                        ...
                        String str4 = str3.split(WebViewLogEventConsumer.DDTAGS_SEPARATOR)[1];
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i19 = 0; i19 < size; i19++) {
                ...
                dArr6[i19][0] = (double) motionPathsArr[i19].f29x;
                dArr6[i19][1] = (double) motionPathsArr[i19].f30y;
            }
