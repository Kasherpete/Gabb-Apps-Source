...
public final class MetadataList extends Table {
    ...
    public MetadataItem list(MetadataItem metadataItem, int i) {
        ...
        if (__offset != 0) {
            return metadataItem.__assign(__indirect(__vector(__offset) + (i * 4)), this.f75bb);
        }
        return null;
    }
    ...
    public MetadataItem.Vector listVector(MetadataItem.Vector vector) {
        int __offset = __offset(6);
        if (__offset != 0) {
            return vector.__assign(__vector(__offset), 4, this.f75bb);
        }
        return null;
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataList get(MetadataList metadataList, int i) {
            return metadataList.__assign(MetadataList.__indirect(__element(i), this.f69bb), this.f69bb);
        }
    }
}
