        ...
        while (i2 < length) {
            ...
            if (charAt2 < 128) {
                ...
                try {
                    ...
                    byteBuffer.put(i, (byte) ((charAt2 & TracingInterceptor.URL_QUERY_PARAMS_BLOCK_SEPARATOR) | 128));
                    position = i;
                ...
                byteBuffer.put(position, (byte) ((charAt2 & TracingInterceptor.URL_QUERY_PARAMS_BLOCK_SEPARATOR) | 128));
            } else {
                int i3 = i2 + 1;
                if (i3 != length) {
                    try {
    ...
    private static int encodeUtf8Array(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i7 < length) {
            ...
            if (charAt2 < 128 && i8 < i6) {
                ...
                i8 = i9 + 1;
                bArr[i9] = (byte) ((charAt2 & TracingInterceptor.URL_QUERY_PARAMS_BLOCK_SEPARATOR) | 128);
                i7++;
                ...
                i4 = i11 + 1;
                bArr[i11] = (byte) ((charAt2 & TracingInterceptor.URL_QUERY_PARAMS_BLOCK_SEPARATOR) | 128);
            } else if (i8 <= i6 - 4) {
                int i12 = i7 + 1;
