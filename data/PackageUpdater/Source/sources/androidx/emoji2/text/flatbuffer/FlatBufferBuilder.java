...
public class FlatBufferBuilder {
    ...
    public FlatBufferBuilder(int i, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf82) {
        ...
        if (byteBuffer != null) {
            this.f70bb = byteBuffer;
            byteBuffer.clear();
            this.f70bb.order(ByteOrder.LITTLE_ENDIAN);
        } else {
            this.f70bb = byteBufferFactory.newByteBuffer(i);
        }
        this.utf8 = utf82;
        this.space = this.f70bb.capacity();
    }
    ...
    public int offset() {
        return this.f70bb.capacity() - this.space;
    }

    public void pad(int i) {
        for (int i2 = 0; i2 < i; i2++) {
            ByteBuffer byteBuffer = this.f70bb;
            int i3 = this.space - 1;
            this.space = i3;
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer order = this.f70bb.slice().order(ByteOrder.LITTLE_ENDIAN);
        order.limit(i4);
        return order;
    }
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.utf8.encodeUtf8(charSequence, this.f70bb);
        return endVector();
    }
    ...
    public int createString(ByteBuffer byteBuffer) {
        ...
        ByteBuffer byteBuffer2 = this.f70bb;
        int i = this.space - remaining;
        this.space = i;
        byteBuffer2.position(i);
        this.f70bb.put(byteBuffer);
        return endVector();
    }
    ...
    public int endTable() {
        ...
        while (true) {
            ...
            int capacity = this.f70bb.capacity() - this.vtables[i4];
            int i5 = this.space;
            short s = this.f70bb.getShort(capacity);
            if (s == this.f70bb.getShort(i5)) {
                int i6 = 2;
                while (i6 < s) {
                    if (this.f70bb.getShort(capacity + i6) == this.f70bb.getShort(i5 + i6)) {
                        i6 += 2;
                    }
                }
                i = this.vtables[i4];
        ...
        if (i != 0) {
            int capacity2 = this.f70bb.capacity() - offset;
            this.space = capacity2;
            this.f70bb.putInt(capacity2, i - offset);
        } else {
    ...
    public void required(int i, int i2) {
        int capacity = this.f70bb.capacity() - i;
        if (!(this.f70bb.getShort((capacity - this.f70bb.getInt(capacity)) + i2) != 0)) {
    ...
    public void finish(int i, boolean z) {
        ...
        addOffset(i);
        if (z) {
            addInt(this.f70bb.capacity() - this.space);
        }
        this.f70bb.position(this.space);
        this.finished = true;
    }
    ...
    public byte[] sizedByteArray(int i, int i2) {
        ...
        this.f70bb.position(i);
        this.f70bb.get(bArr);
        return bArr;
    }

    public byte[] sizedByteArray() {
        return sizedByteArray(this.space, this.f70bb.capacity() - this.space);
    }

    public InputStream sizedInputStream() {
        finished();
        ByteBuffer duplicate = this.f70bb.duplicate();
        duplicate.position(this.space);
        duplicate.limit(this.f70bb.capacity());
