...
public class FlexBuffersBuilder {
    ...
    /* renamed from: bb */
    public final ReadWriteBuf f73bb;
    ...
    public FlexBuffersBuilder(ReadWriteBuf readWriteBuf, int i) {
        ...
        this.keyComparator = new Comparator<Value>() {
            public int compare(Value value, Value value2) {
                ...
                int i2 = value2.key;
                do {
                    b = FlexBuffersBuilder.this.f73bb.get(i);
                    b2 = FlexBuffersBuilder.this.f73bb.get(i2);
                    if (b == 0) {
                        return b - b2;
                    }
                    i++;
    ...
    private int putKey(String str) {
        ...
        int writePosition = this.f73bb.writePosition();
        if ((this.flags & 1) != 0) {
            ...
            this.f73bb.put(bytes, 0, bytes.length);
            this.f73bb.put((byte) 0);
            this.keyPool.put(str, Integer.valueOf(writePosition));
            return writePosition;
        }
        byte[] bytes2 = str.getBytes(StandardCharsets.UTF_8);
        this.f73bb.put(bytes2, 0, bytes2.length);
        this.f73bb.put((byte) 0);
        this.keyPool.put(str, Integer.valueOf(writePosition));
        return writePosition;
    }
    ...
    private Value writeBlob(int i, byte[] bArr, int i2, boolean z) {
        ...
        int writePosition = this.f73bb.writePosition();
        this.f73bb.put(bArr, 0, bArr.length);
        if (z) {
            this.f73bb.put((byte) 0);
        }
    ...
    private int align(int i) {
        int i2 = 1 << i;
        int access$100 = Value.paddingBytes(this.f73bb.writePosition(), i2);
        while (true) {
            int i3 = access$100 - 1;
            if (access$100 == 0) {
                return i2;
    ...
    private void writeInt(long j, int i) {
        if (i == 1) {
            this.f73bb.put((byte) ((int) j));
        } else if (i == 2) {
            this.f73bb.putShort((short) ((int) j));
        } else if (i == 4) {
            this.f73bb.putInt((int) j);
        } else if (i == 8) {
            this.f73bb.putLong(j);
        }
    }
    ...
    public ByteBuffer finish() {
        int align = align(this.stack.get(0).elemWidth(this.f73bb.writePosition(), 0));
        writeAny(this.stack.get(0), align);
        this.f73bb.put(this.stack.get(0).storedPackedType());
        this.f73bb.put((byte) align);
        this.finished = true;
        return ByteBuffer.wrap(this.f73bb.data(), 0, this.f73bb.writePosition());
    }
    ...
    private Value createVector(int i, int i2, int i3, boolean z, boolean z2, Value value) {
        ...
        if (value2 != null) {
            max = Math.max(max, value2.elemWidth(this.f73bb.writePosition(), 0));
            i4 = 3;
        } else {
            i4 = 1;
        }
        ...
        for (int i9 = i2; i9 < this.stack.size(); i9++) {
            i8 = Math.max(i8, this.stack.get(i9).elemWidth(this.f73bb.writePosition(), i9 + i4));
            int i10 = i2;
            if (z && i9 == i10) {
        ...
        if (!z) {
            while (i11 < this.stack.size()) {
                this.f73bb.put(this.stack.get(i11).storedPackedType(i8));
                i11++;
            }
        }
        if (value2 != null) {
    ...
    private void writeOffset(long j, int i) {
        writeInt((long) ((int) (((long) this.f73bb.writePosition()) - j)), i);
    }
    ...
    private void writeDouble(double d, int i) {
        if (i == 4) {
            this.f73bb.putFloat((float) d);
        } else if (i == 8) {
            this.f73bb.putDouble(d);
        }
    }
    ...
    private Value createKeyVector(int i, int i2) {
        ...
        while (i3 < this.stack.size()) {
            i3++;
            max = Math.max(max, Value.elemWidth(4, 0, (long) this.stack.get(i3).key, this.f73bb.writePosition(), i3));
        }
        int align = align(max);
        writeInt(j, align);
        int writePosition = this.f73bb.writePosition();
