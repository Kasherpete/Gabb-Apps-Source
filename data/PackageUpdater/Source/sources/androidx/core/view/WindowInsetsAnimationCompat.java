...
public final class WindowInsetsAnimationCompat {
    ...
    private static class Impl21 extends Impl {
        ...
        static void setCallback(View view, Callback callback) {
            Object tag = view.getTag(C0179R.C0182id.tag_on_apply_window_listener);
            if (callback == null) {
                view.setTag(C0179R.C0182id.tag_window_insets_animation_callback, (Object) null);
                if (tag == null) {
            ...
            view.setTag(C0179R.C0182id.tag_window_insets_animation_callback, createProxyListener);
            if (tag == null) {
        ...
        static WindowInsets forwardToViewIfNeeded(View view, WindowInsets windowInsets) {
            if (view.getTag(C0179R.C0182id.tag_on_apply_window_listener) != null) {
                return windowInsets;
            }
        ...
        static Callback getCallback(View view) {
            Object tag = view.getTag(C0179R.C0182id.tag_window_insets_animation_callback);
