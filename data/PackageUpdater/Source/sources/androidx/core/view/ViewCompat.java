...
public class ViewCompat {
    private static final int[] ACCESSIBILITY_ACTIONS_RESOURCE_IDS = {C0179R.C0182id.accessibility_custom_action_0, C0179R.C0182id.accessibility_custom_action_1, C0179R.C0182id.accessibility_custom_action_2, C0179R.C0182id.accessibility_custom_action_3, C0179R.C0182id.accessibility_custom_action_4, C0179R.C0182id.accessibility_custom_action_5, C0179R.C0182id.accessibility_custom_action_6, C0179R.C0182id.accessibility_custom_action_7, C0179R.C0182id.accessibility_custom_action_8, C0179R.C0182id.accessibility_custom_action_9, C0179R.C0182id.accessibility_custom_action_10, C0179R.C0182id.accessibility_custom_action_11, C0179R.C0182id.accessibility_custom_action_12, C0179R.C0182id.accessibility_custom_action_13, C0179R.C0182id.accessibility_custom_action_14, C0179R.C0182id.accessibility_custom_action_15, C0179R.C0182id.accessibility_custom_action_16, C0179R.C0182id.accessibility_custom_action_17, C0179R.C0182id.accessibility_custom_action_18, C0179R.C0182id.accessibility_custom_action_19, C0179R.C0182id.accessibility_custom_action_20, C0179R.C0182id.accessibility_custom_action_21, C0179R.C0182id.accessibility_custom_action_22, C0179R.C0182id.accessibility_custom_action_23, C0179R.C0182id.accessibility_custom_action_24, C0179R.C0182id.accessibility_custom_action_25, C0179R.C0182id.accessibility_custom_action_26, C0179R.C0182id.accessibility_custom_action_27, C0179R.C0182id.accessibility_custom_action_28, C0179R.C0182id.accessibility_custom_action_29, C0179R.C0182id.accessibility_custom_action_30, C0179R.C0182id.accessibility_custom_action_31};
    ...
    private static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        ArrayList arrayList = (ArrayList) view.getTag(C0179R.C0182id.tag_accessibility_actions);
        if (arrayList != null) {
            return arrayList;
        }
        ArrayList arrayList2 = new ArrayList();
        view.setTag(C0179R.C0182id.tag_accessibility_actions, arrayList2);
        return arrayList2;
    }
    ...
    public static void setOnReceiveContentListener(View view, String[] strArr, OnReceiveContentListener onReceiveContentListener) {
        ...
        view.setTag(C0179R.C0182id.tag_on_receive_content_mime_types, strArr);
        view.setTag(C0179R.C0182id.tag_on_receive_content_listener, onReceiveContentListener);
    }
    ...
    public static String[] getOnReceiveContentMimeTypes(View view) {
        ...
        return (String[]) view.getTag(C0179R.C0182id.tag_on_receive_content_mime_types);
    }
    ...
    public static ContentInfoCompat performReceiveContent(View view, ContentInfoCompat contentInfoCompat) {
        ...
        OnReceiveContentListener onReceiveContentListener = (OnReceiveContentListener) view.getTag(C0179R.C0182id.tag_on_receive_content_listener);
        if (onReceiveContentListener == null) {
    ...
    public static void addOnUnhandledKeyEventListener(View view, OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        ...
        ArrayList arrayList = (ArrayList) view.getTag(C0179R.C0182id.tag_unhandled_key_listeners);
        if (arrayList == null) {
            arrayList = new ArrayList();
            view.setTag(C0179R.C0182id.tag_unhandled_key_listeners, arrayList);
        }
    ...
    static boolean dispatchUnhandledKeyEventBeforeHierarchy(View view, KeyEvent keyEvent) {
        ...
        return UnhandledKeyEventManager.m25at(view).preDispatch(keyEvent);
    }
    ...
    static boolean dispatchUnhandledKeyEventBeforeCallback(View view, KeyEvent keyEvent) {
        ...
        return UnhandledKeyEventManager.m25at(view).dispatch(view, keyEvent);
    }
    ...
    private static AccessibilityViewProperty<Boolean> screenReaderFocusableProperty() {
        return new AccessibilityViewProperty<Boolean>(C0179R.C0182id.tag_screen_reader_focusable, Boolean.class, 28) {
    ...
    private static AccessibilityViewProperty<CharSequence> paneTitleProperty() {
        return new AccessibilityViewProperty<CharSequence>(C0179R.C0182id.tag_accessibility_pane_title, CharSequence.class, 8, 28) {
            /* access modifiers changed from: package-private */
    ...
    private static AccessibilityViewProperty<CharSequence> stateDescriptionProperty() {
        return new AccessibilityViewProperty<CharSequence>(C0179R.C0182id.tag_state_description, CharSequence.class, 64, 30) {
            /* access modifiers changed from: package-private */
            public CharSequence frameworkGet(View view) {
    ...
    private static AccessibilityViewProperty<Boolean> accessibilityHeadingProperty() {
        return new AccessibilityViewProperty<Boolean>(C0179R.C0182id.tag_accessibility_heading, Boolean.class, 28) {
            /* access modifiers changed from: package-private */
            public Boolean frameworkGet(View view) {
    ...
    static class UnhandledKeyEventManager {
        ...
        /* renamed from: at */
        static UnhandledKeyEventManager m25at(View view) {
            UnhandledKeyEventManager unhandledKeyEventManager = (UnhandledKeyEventManager) view.getTag(C0179R.C0182id.tag_unhandled_key_event_manager);
            if (unhandledKeyEventManager != null) {
                return unhandledKeyEventManager;
            }
            UnhandledKeyEventManager unhandledKeyEventManager2 = new UnhandledKeyEventManager();
            view.setTag(C0179R.C0182id.tag_unhandled_key_event_manager, unhandledKeyEventManager2);
    ...
    private static class Api21Impl {
        ...
        static void setOnApplyWindowInsetsListener(final View view, final OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
            if (Build.VERSION.SDK_INT < 30) {
                view.setTag(C0179R.C0182id.tag_on_apply_window_listener, onApplyWindowInsetsListener);
            }
            if (onApplyWindowInsetsListener == null) {
                view.setOnApplyWindowInsetsListener((View.OnApplyWindowInsetsListener) view.getTag(C0179R.C0182id.tag_window_insets_animation_callback));
            } else {
        ...
        static void callCompatInsetAnimationCallback(WindowInsets windowInsets, View view) {
            View.OnApplyWindowInsetsListener onApplyWindowInsetsListener = (View.OnApplyWindowInsetsListener) view.getTag(C0179R.C0182id.tag_window_insets_animation_callback);
            if (onApplyWindowInsetsListener != null) {
    ...
    static class Api28Impl {
        ...
        static void addOnUnhandledKeyEventListener(View view, OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
            SimpleArrayMap simpleArrayMap = (SimpleArrayMap) view.getTag(C0179R.C0182id.tag_unhandled_key_listeners);
            if (simpleArrayMap == null) {
                simpleArrayMap = new SimpleArrayMap();
                view.setTag(C0179R.C0182id.tag_unhandled_key_listeners, simpleArrayMap);
            }
