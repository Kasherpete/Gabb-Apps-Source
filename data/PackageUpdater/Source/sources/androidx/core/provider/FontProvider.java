    ...
    private static final Comparator<byte[]> sByteArrayComparator = new Comparator<byte[]>() {
        ...
        public int compare(byte[] r4, byte[] r5) {
            ...
            L_0x001b:
                return r3
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.provider.FontProvider.C02241.compare(byte[], byte[]):int");
        }
    };
        ...
        try {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    int i6 = columnIndex5 != -1 ? cursor.getInt(columnIndex5) : DataOkHttpUploaderV2.HTTP_BAD_REQUEST;
