...
import androidx.fragment.C0314R;
...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    public final void setFragmentResultListener(final String str, LifecycleOwner lifecycleOwner, final FragmentResultListener fragmentResultListener) {
        ...
        if (lifecycle.getCurrentState() != Lifecycle.State.DESTROYED) {
            C03606 r0 = new LifecycleEventObserver() {
    ...
    static Fragment getViewFragment(View view) {
        Object tag = view.getTag(C0314R.C0317id.fragment_container_view_tag);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:97:0x0172  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    private void executeOpsTogether(java.util.ArrayList<androidx.fragment.app.BackStackRecord> r18, java.util.ArrayList<java.lang.Boolean> r19, int r20, int r21) {
        ...
        L_0x0083:
            ...
            androidx.fragment.app.FragmentTransaction$Op r7 = (androidx.fragment.app.FragmentTransaction.C0371Op) r7
        ...
        L_0x00e3:
            ...
            androidx.fragment.app.FragmentTransaction$Op r9 = (androidx.fragment.app.FragmentTransaction.C0371Op) r9
        ...
        L_0x0101:
            ...
            androidx.fragment.app.FragmentTransaction$Op r8 = (androidx.fragment.app.FragmentTransaction.C0371Op) r8
    ...
    private Set<SpecialEffectsController> collectChangedControllers(ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        while (i < i2) {
            ...
            while (it.hasNext()) {
                Fragment fragment = ((FragmentTransaction.C0371Op) it.next()).mFragment;
    ...
    private void setVisibleRemovingFragment(Fragment fragment) {
        ...
        if (fragmentContainer != null && fragment.getEnterAnim() + fragment.getExitAnim() + fragment.getPopEnterAnim() + fragment.getPopExitAnim() > 0) {
            if (fragmentContainer.getTag(C0314R.C0317id.visible_removing_fragment_view_tag) == null) {
                fragmentContainer.setTag(C0314R.C0317id.visible_removing_fragment_view_tag, fragment);
            }
            ((Fragment) fragmentContainer.getTag(C0314R.C0317id.visible_removing_fragment_view_tag)).setPopDirection(fragment.getPopDirection());
        }
    }
