...
class FragmentAnim {
    ...
    static AnimationOrAnimator loadAnimation(Context context, Fragment fragment, boolean z, boolean z2) {
        ...
        if (!(fragment.mContainer == null || fragment.mContainer.getTag(C0314R.C0317id.visible_removing_fragment_view_tag) == null)) {
            fragment.mContainer.setTag(C0314R.C0317id.visible_removing_fragment_view_tag, (Object) null);
        }
    ...
    private static int transitToAnimResourceId(int i, boolean z) {
        if (i == 4097) {
            return z ? C0314R.animator.fragment_open_enter : C0314R.animator.fragment_open_exit;
        }
        if (i != 4099) {
            if (i != 8194) {
                return -1;
            }
            return z ? C0314R.animator.fragment_close_enter : C0314R.animator.fragment_close_exit;
        } else if (z) {
            return C0314R.animator.fragment_fade_enter;
        } else {
            return C0314R.animator.fragment_fade_exit;
        }
    }
